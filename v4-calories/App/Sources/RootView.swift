...
enum Tab { case today, weight, trends }
...
struct RootView: View {
    ...
    @ViewBuilder private var content: some View {
        switch tab {
        case .today:  TodayView(openEntry: { entryOpen = true }, openSettings: { settingsOpen = true })
    ...
    private var tabBar: some View {
        HStack {
            ...
            tabButton(.weight, system: "chart.line.uptrend.xyaxis", label: "Weight")
            Spacer()
