...
use crate::headless_editor::delete_char;
use crate::headless_editor::handle_insert;
use crate::headless_editor::insert_normal_text;

use crate::headless_editor::{TextBuffer, VirtualCursor};
...
mod test {
    ...
    use crate::headless_editor::{SimpleCursor, SimpleTextBuffer, TextBuffer, TokenTextBuffer, VirtualCursor};
