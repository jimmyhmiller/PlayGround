...
impl KeyCode {
    pub fn map_winit_vk_to_keycode(v: WinitKeyCode) -> Option<KeyCode> {
        ...
        use WinitKeyCode::*;
        match v {
            Numpad0 => Some(KeyCode::Key0),
            Numpad1 => Some(KeyCode::Key1),
            Numpad2 => Some(KeyCode::Key2),
            Numpad3 => Some(KeyCode::Key3),
            Numpad4 => Some(KeyCode::Key4),
            Numpad5 => Some(KeyCode::Key5),
            Numpad6 => Some(KeyCode::Key6),
            Numpad7 => Some(KeyCode::Key7),
            Numpad8 => Some(KeyCode::Key8),
            Numpad9 => Some(KeyCode::Key9),
            KeyA => Some(KeyCode::A),
            KeyB => Some(KeyCode::B),
            KeyC => Some(KeyCode::C),
            KeyD => Some(KeyCode::D),
