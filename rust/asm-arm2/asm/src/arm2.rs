...
impl Asm {
    pub fn encode(&self) -> u32 {
        match self {
        Asm::AbsAdvsimd { size,rn,rd,q,class_selector } => {
        ...
        Asm::AddAddsubExt { sf,rm,option,imm3,rn,rd } => {
        ...
        Asm::AddAddsubImm { sf,sh,imm12,rn,rd } => {
        ...
        Asm::AddAddsubShift { sf,shift,rm,imm6,rn,rd } => {
        ...
        Asm::AddAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::AddhnAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::AddpAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        Asm::AddsAddsubExt { sf,rm,option,imm3,rn,rd } => {
        ...
        Asm::AddsAddsubImm { sf,sh,imm12,rn,rd } => {
        ...
        Asm::AddsAddsubShift { sf,shift,rm,imm6,rn,rd } => {
        ...
        0b01001110_00_10100_0010_1_10_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::AeseAdvsimd { rn,rd } => {
        0b01001110_00_10100_0010_0_10_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::AesimcAdvsimd { rn,rd } => {
        0b01001110_00_10100_0011_1_10_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::AesmcAdvsimd { rn,rd } => {
        0b01001110_00_10100_0011_0_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::AndLogImm { sf,n,immr,imms,rn,rd } => {
        ...
        Asm::AndLogShift { sf,shift,rm,imm6,rn,rd } => {
        ...
        Asm::AndsLogImm { sf,n,immr,imms,rn,rd } => {
        ...
        Asm::AndsLogShift { sf,shift,rm,imm6,rn,rd } => {
        ...
        Asm::AsrSbfm { sf,n,immr,imms,rn,rd } => {
        ...
        Asm::Autda { z,rn,rd } => {
        0b1_1_0_11010110_00001_0_0_0_110_00000_00000
        | (*z as u32) << 13
        | rn << 5
        | rd << 0
        }
        Asm::Autdb { z,rn,rd } => {
        0b1_1_0_11010110_00001_0_0_0_111_00000_00000
        | (*z as u32) << 13
        | rn << 5
        | rd << 0
        }
        Asm::Autia { z,rn,rd,crm,op2,class_selector } => {
        match class_selector {
        ...
        Asm::Autib { z,rn,rd,crm,op2,class_selector } => {
        match class_selector {
        ...
        Asm::Axflag {  } => {
        0b1101010100_0_00_000_0100_010_11111
        }
        ...
        0b110011100_01_00000_0_00000_00000_00000
        | rm << 16
        | ra << 10
        | rn << 5
        | rd << 0
        }
        Asm::BfcBfm { sf,n,immr,imms,rd } => {
        ...
        0b0_0_0_11110_01_1_000110_10000_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::BfcvtnAdvsimd { q,rn,rd } => {
        0b0_0_0_01110_10_10000_10110_10_00000_00000
        | (*q as u32) << 30
        | rn << 5
        | rd << 0
        }
        Asm::BfdotAdvsimdElt { q,l,m,rm,h,rn,rd } => {
        ...
        Asm::BfmlalAdvsimdElt { q,l,m,rm,h,rn,rd } => {
        ...
        0b0_1_1_01110_01_0_00000_1_1101_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::BfxilBfm { sf,n,immr,imms,rn,rd } => {
        0b0_01_100110_0_000000_000000_00000_00000
        | (*sf as u32) << 31
        | (*n as u32) << 22
        | (*immr as u32) << 16
        ...
        Asm::BicAdvsimdImm { q,a,b,c,cmode,d,e,f,g,h,rd } => {
        ...
        Asm::BicLogShift { sf,shift,rm,imm6,rn,rd } => {
        ...
        Asm::Bics { sf,shift,rm,imm6,rn,rd } => {
        ...
        Asm::Bl { imm26 } => {
        0b1_00101_00000000000000000000000000
        | truncate_imm::<_, 26>(*imm26) << 0
        }
        Asm::Blr { rn } => {
        0b1101011_0_0_01_11111_0000_0_0_00000_00000
        | rn << 5
        }
        Asm::Blra { z,m,rn,rm } => {
        ...
        Asm::Br { rn } => {
        0b1101011_0_0_00_11111_0000_0_0_00000_00000
        | rn << 5
        }
        Asm::Bra { z,m,rn,rm } => {
        ...
        Asm::Brk { imm16 } => {
        0b11010100_001_0000000000000000_000_00
        | (*imm16 as u32) << 5
        }
        ...
        Asm::Bti { op2 } => {
        0b1101010100_0_00_011_0010_0100_000_11111
        | (*op2 as u32) << 5
        }
        Asm::Cas { size,l,rs,o0,rn,rt } => {
        ...
        Asm::CcmnImm { sf,imm5,cond,rn,nzcv } => {
        ...
        Asm::CcmnReg { sf,rm,cond,rn,nzcv } => {
        ...
        Asm::CcmpImm { sf,imm5,cond,rn,nzcv } => {
        ...
        Asm::CcmpReg { sf,rm,cond,rn,nzcv } => {
        ...
        Asm::Cfinv {  } => {
        0b1101010100_0_0_0_000_0100_000_11111
        }
        Asm::CfpSys { rt } => {
        0b1101010100_0_01_011_0111_0011_100_00000
        | rt << 0
        }
        Asm::CincCsinc { sf,rd } => {
        0b0_0_0_11010100_0_1_00000
        | (*sf as u32) << 31
        | rd << 0
        }
        Asm::CinvCsinv { sf,rd } => {
        0b0_1_0_11010100_0_0_00000
        | (*sf as u32) << 31
        | rd << 0
        }
        Asm::Clrex { crm } => {
        0b1101010100_0_00_011_0011_0000_010_11111
        | (*crm as u32) << 8
        }
        ...
        Asm::ClsInt { sf,rn,rd } => {
        0b0_1_0_11010110_00000_00010_1_00000_00000
        | (*sf as u32) << 31
        | rn << 5
        | rd << 0
        }
        ...
        Asm::ClzInt { sf,rn,rd } => {
        0b0_1_0_11010110_00000_00010_0_00000_00000
        | (*sf as u32) << 31
        | rn << 5
        | rd << 0
        }
        Asm::CmeqAdvsimdReg { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::CmeqAdvsimdZero { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::CmgeAdvsimdReg { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::CmgeAdvsimdZero { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::CmgtAdvsimdReg { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::CmgtAdvsimdZero { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::CmhiAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::CmhsAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::CmleAdvsimd { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::CmltAdvsimd { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::CmnAddsAddsubExt { sf,rm,option,imm3,rn } => {
        ...
        Asm::CmnAddsAddsubShift { sf,shift,rm,imm6,rn } => {
        ...
        Asm::CmpSubsAddsubExt { sf,rm,option,imm3,rn } => {
        ...
        Asm::CmpSubsAddsubShift { sf,shift,rm,imm6,rn } => {
        ...
        Asm::CmtstAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::CppSys { rt } => {
        0b1101010100_0_01_011_0111_0011_111_00000
        | rt << 0
        }
        Asm::Cpyfp { sz,op1,rs,rn,rd } => {
        ...
        Asm::CsetCsinc { sf,rd } => {
        0b0_0_0_11010100_11111_0_1_11111_00000
        | (*sf as u32) << 31
        | rd << 0
        }
        Asm::CsetmCsinv { sf,rd } => {
        0b0_1_0_11010100_11111_0_0_11111_00000
        | (*sf as u32) << 31
        | rd << 0
        }
        Asm::Csinc { sf,rm,cond,rn,rd } => {
        ...
        Asm::Dcps1 { imm16 } => {
        0b11010100_101_0000000000000000_000_01
        | (*imm16 as u32) << 5
        }
        Asm::Dcps2 { imm16 } => {
        0b11010100_101_0000000000000000_000_10
        | (*imm16 as u32) << 5
        }
        Asm::Dcps3 { imm16 } => {
        0b11010100_101_0000000000000000_000_11
        | (*imm16 as u32) << 5
        }
        Asm::Dgh {  } => {
        ...
        Asm::Dmb { crm } => {
        0b1101010100_0_00_011_0011_0000_1_01_11111
        | (*crm as u32) << 8
        }
        Asm::Drps {  } => {
        0b1101011_0101_11111_000000_11111_00000
        }
        Asm::Dsb { crm,imm2,class_selector } => {
        match class_selector {
        DsbSelector::MemoryBarrier => {
        0b1101010100_0_00_011_0011_0000_1_00_11111
        | (*crm as u32) << 8
        }
        DsbSelector::MemoryNxsBarrier => {
        0b11010101000000110011_00_10_0_01_11111
        | (*imm2 as u32) << 10
        }
        }
        }
        Asm::DupAdvsimdElt { imm5,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::DvpSys { rt } => {
        0b1101010100_0_01_011_0111_0011_101_00000
        | rt << 0
        }
        Asm::Eon { sf,shift,rm,imm6,rn,rd } => {
        ...
        0b110011100_00_00000_0_00000_00000_00000
        | rm << 16
        | ra << 10
        | rn << 5
        | rd << 0
        ...
        Asm::EorLogImm { sf,n,immr,imms,rn,rd } => {
        ...
        Asm::EorLogShift { sf,shift,rm,imm6,rn,rd } => {
        ...
        Asm::Ereta { m } => {
        0b1101011_0_100_11111_0000_1_0_11111_11111
        | (*m as u32) << 10
        }
        Asm::Esb {  } => {
        0b1101010100_0_00_011_0010_0010_000_11111
        }
        Asm::ExtAdvsimd { q,rm,imm4,rn,rd } => {
        ...
        Asm::FabdAdvsimd { rm,rn,rd,sz,q,class_selector } => {
        match class_selector {
        FabdAdvsimdSelector::ScalarHalfPrecision => {
        0b01_1_11110_1_10_00000_00_010_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FabsAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FacgeAdvsimd { rm,rn,rd,sz,q,class_selector } => {
        match class_selector {
        FacgeAdvsimdSelector::ScalarHalfPrecision => {
        0b01_1_11110_0_10_00000_00_10_1_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FacgtAdvsimd { rm,rn,rd,sz,q,class_selector } => {
        match class_selector {
        FacgtAdvsimdSelector::ScalarHalfPrecision => {
        0b01_1_11110_1_10_00000_00_10_1_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FaddAdvsimd { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FaddpAdvsimdPair { sz,rn,rd,class_selector } => {
        match class_selector {
        ...
        Asm::FaddpAdvsimdVec { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FcaddAdvsimdVec { q,size,rm,rot,rn,rd } => {
        ...
        Asm::FccmpFloat { ftype,rm,cond,rn,nzcv } => {
        ...
        Asm::FccmpeFloat { ftype,rm,cond,rn,nzcv } => {
        ...
        Asm::FcmeqAdvsimdReg { rm,rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcmeqAdvsimdRegSelector::ScalarHalfPrecision => {
        0b01_0_11110_0_10_00000_00_10_0_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcmeqAdvsimdZero { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcmeqAdvsimdZeroSelector::ScalarHalfPrecision => {
        0b01_0_11110_1_111100_0110_1_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcmgeAdvsimdReg { rm,rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcmgeAdvsimdRegSelector::ScalarHalfPrecision => {
        0b01_1_11110_0_10_00000_00_10_0_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcmgeAdvsimdZero { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcmgeAdvsimdZeroSelector::ScalarHalfPrecision => {
        0b01_1_11110_1_111100_0110_0_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcmgtAdvsimdReg { rm,rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcmgtAdvsimdRegSelector::ScalarHalfPrecision => {
        0b01_1_11110_1_10_00000_00_10_0_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcmgtAdvsimdZero { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcmgtAdvsimdZeroSelector::ScalarHalfPrecision => {
        0b01_0_11110_1_111100_0110_0_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcmlaAdvsimdElt { q,size,l,m,rm,rot,h,rn,rd } => {
        ...
        Asm::FcmlaAdvsimdVec { q,size,rm,rot,rn,rd } => {
        ...
        Asm::FcmleAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcmleAdvsimdSelector::ScalarHalfPrecision => {
        0b01_1_11110_1_111100_0110_1_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcmltAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcmltAdvsimdSelector::ScalarHalfPrecision => {
        0b01_0_11110_1_111100_01110_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcselFloat { ftype,rm,cond,rn,rd } => {
        ...
        Asm::FcvtasAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcvtasAdvsimdSelector::ScalarHalfPrecision => {
        0b01_0_11110_0_111100_11100_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtauAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcvtauAdvsimdSelector::ScalarHalfPrecision => {
        0b01_1_11110_0_111100_11100_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtmsAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcvtmsAdvsimdSelector::ScalarHalfPrecision => {
        0b01_0_11110_0_111100_1101_1_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtmuAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcvtmuAdvsimdSelector::ScalarHalfPrecision => {
        0b01_1_11110_0_111100_1101_1_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtnsAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcvtnsAdvsimdSelector::ScalarHalfPrecision => {
        0b01_0_11110_0_111100_1101_0_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtnuAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcvtnuAdvsimdSelector::ScalarHalfPrecision => {
        0b01_1_11110_0_111100_1101_0_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtpsAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcvtpsAdvsimdSelector::ScalarHalfPrecision => {
        0b01_0_11110_1_111100_1101_0_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtpuAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcvtpuAdvsimdSelector::ScalarHalfPrecision => {
        0b01_1_11110_1_111100_1101_0_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtxnAdvsimd { sz,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::FcvtzsAdvsimdFix { immb,rn,rd,q,class_selector } => {
        match class_selector {
        FcvtzsAdvsimdFixSelector::Scalar => {
        0b01_0_111110_000_11111_1_00000_00000
        | (*immb as u32) << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtzsAdvsimdInt { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcvtzsAdvsimdIntSelector::ScalarHalfPrecision => {
        0b01_0_11110_1_111100_1101_1_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtzsFloatFix { sf,ftype,scale,rn,rd } => {
        ...
        Asm::FcvtzuAdvsimdFix { immb,rn,rd,q,class_selector } => {
        match class_selector {
        FcvtzuAdvsimdFixSelector::Scalar => {
        0b01_1_111110_000_11111_1_00000_00000
        | (*immb as u32) << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtzuAdvsimdInt { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FcvtzuAdvsimdIntSelector::ScalarHalfPrecision => {
        0b01_1_11110_1_111100_1101_1_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FcvtzuFloatFix { sf,ftype,scale,rn,rd } => {
        ...
        Asm::FdivAdvsimd { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::Fjcvtzs { rn,rd } => {
        0b0_0_0_11110_01_1_11_110_000000_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::FmaddFloat { ftype,rm,ra,rn,rd } => {
        ...
        Asm::FmaxAdvsimd { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FmaxnmAdvsimd { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FmaxnmpAdvsimdPair { sz,rn,rd,class_selector } => {
        match class_selector {
        ...
        Asm::FmaxnmpAdvsimdVec { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FmaxnmvAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FmaxpAdvsimdPair { sz,rn,rd,class_selector } => {
        match class_selector {
        ...
        Asm::FmaxpAdvsimdVec { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FmaxvAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FminAdvsimd { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FminnmAdvsimd { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FminnmpAdvsimdPair { sz,rn,rd,class_selector } => {
        match class_selector {
        ...
        Asm::FminnmpAdvsimdVec { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FminnmvAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FminpAdvsimdPair { sz,rn,rd,class_selector } => {
        match class_selector {
        ...
        Asm::FminpAdvsimdVec { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FminvAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FmlaAdvsimdElt { l,m,rm,h,rn,rd,sz,q,class_selector } => {
        match class_selector {
        ...
        Asm::FmlaAdvsimdVec { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FmlalAdvsimdElt { q,l,m,rm,h,rn,rd,class_selector } => {
        match class_selector {
        ...
        Asm::FmlalAdvsimdVec { q,rm,rn,rd,class_selector } => {
        match class_selector {
        ...
        Asm::FmlsAdvsimdElt { l,m,rm,h,rn,rd,sz,q,class_selector } => {
        match class_selector {
        ...
        Asm::FmlsAdvsimdVec { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FmlslAdvsimdElt { q,l,m,rm,h,rn,rd,class_selector } => {
        match class_selector {
        ...
        Asm::FmlslAdvsimdVec { q,rm,rn,rd,class_selector } => {
        match class_selector {
        ...
        Asm::FmovAdvsimd { q,a,b,c,d,e,f,g,h,rd,op,class_selector } => {
        match class_selector {
        ...
        Asm::FmovFloatGen { sf,ftype,rmode,opcode,rn,rd } => {
        0b0_0_0_11110_00_1_00_000_000000_00000_00000
        | (*sf as u32) << 31
        | (*ftype as u32) << 22
        | rmode << 19
        ...
        Asm::FmsubFloat { ftype,rm,ra,rn,rd } => {
        ...
        Asm::FmulAdvsimdElt { l,m,rm,h,rn,rd,sz,q,class_selector } => {
        match class_selector {
        ...
        Asm::FmulAdvsimdVec { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FmulxAdvsimdElt { l,m,rm,h,rn,rd,sz,q,class_selector } => {
        match class_selector {
        ...
        Asm::FmulxAdvsimdVec { rm,rn,rd,sz,q,class_selector } => {
        match class_selector {
        FmulxAdvsimdVecSelector::ScalarHalfPrecision => {
        0b01_0_11110_0_10_00000_00_011_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FnegAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FnmaddFloat { ftype,rm,ra,rn,rd } => {
        ...
        Asm::FnmsubFloat { ftype,rm,ra,rn,rd } => {
        ...
        Asm::FrecpeAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FrecpeAdvsimdSelector::ScalarHalfPrecision => {
        0b01_0_11110_1_111100_11101_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FrecpsAdvsimd { rm,rn,rd,sz,q,class_selector } => {
        match class_selector {
        FrecpsAdvsimdSelector::ScalarHalfPrecision => {
        0b01_0_11110_0_10_00000_00_111_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FrecpxAdvsimd { rn,rd,sz,class_selector } => {
        match class_selector {
        FrecpxAdvsimdSelector::HalfPrecision => {
        0b01_0_11110_1_111100_11111_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FrintaAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FrintiAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FrintmAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FrintnAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FrintpAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FrintxAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FrintzAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FrsqrteAdvsimd { rn,rd,sz,q,class_selector } => {
        match class_selector {
        FrsqrteAdvsimdSelector::ScalarHalfPrecision => {
        0b01_1_11110_1_111100_11101_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FrsqrtsAdvsimd { rm,rn,rd,sz,q,class_selector } => {
        match class_selector {
        FrsqrtsAdvsimdSelector::ScalarHalfPrecision => {
        0b01_0_11110_1_10_00000_00_111_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::FsqrtAdvsimd { q,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::FsubAdvsimd { q,rm,rn,rd,sz,class_selector } => {
        match class_selector {
        ...
        Asm::Hlt { imm16 } => {
        0b11010100_010_0000000000000000_000_00
        | (*imm16 as u32) << 5
        }
        Asm::Hvc { imm16 } => {
        0b11010100_000_0000000000000000_000_10
        | (*imm16 as u32) << 5
        }
        ...
        Asm::Isb { crm } => {
        0b1101010100_0_00_011_0011_0000_1_10_11111
        | (*crm as u32) << 8
        }
        Asm::Ld1AdvsimdMult { q,opcode,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld1AdvsimdSngl { q,opcode,s,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld1rAdvsimd { q,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld2AdvsimdMult { q,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld2AdvsimdSngl { q,opcode,s,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld2rAdvsimd { q,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld3AdvsimdMult { q,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld3AdvsimdSngl { q,opcode,s,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld3rAdvsimd { q,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld4AdvsimdMult { q,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld4AdvsimdSngl { q,opcode,s,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld4rAdvsimd { q,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::Ld64b { rn,rt } => {
        0b11_111_0_00_0_0_1_11111_1_101_00_00000_00000
        | rn << 5
        | rt << 0
        }
        Asm::Ldadd { size,a,r,rs,rn,rt } => {
        ...
        0b00_111_0_00_1_0_1_1_100_00_00000_00000
        | (*size as u32) << 30
        | rn << 5
        | rt << 0
        }
        ...
        Asm::Ldaprh { rn,rt } => {
        0b01_111_0_00_1_0_1_1_100_00_00000_00000
        | rn << 5
        | rt << 0
        }
        ...
        Asm::Ldar { size,rn,rt } => {
        0b00_001000_1_1_0_1_00000_00000
        | (*size as u32) << 30
        | rn << 5
        | rt << 0
        }
        ...
        Asm::Ldarh { rn,rt } => {
        0b01_001000_1_1_0_1_00000_00000
        | rn << 5
        | rt << 0
        }
        ...
        0b00_001000_0_1_0_1_00000_00000
        | (*size as u32) << 30
        | rn << 5
        | rt << 0
        }
        ...
        Asm::Ldaxrh { rn,rt } => {
        0b01_001000_0_1_0_1_00000_00000
        | rn << 5
        | rt << 0
        }
        Asm::Ldclr { size,a,r,rs,rn,rt } => {
        ...
        0b00_001000_1_1_0_0_00000_00000
        | (*size as u32) << 30
        | rn << 5
        | rt << 0
        }
        ...
        Asm::Ldlarh { rn,rt } => {
        0b01_001000_1_1_0_0_00000_00000
        | rn << 5
        | rt << 0
        }
        Asm::LdnpFpsimd { opc,imm7,rt2,rn,rt } => {
        ...
        Asm::LdnpGen { opc,imm7,rt2,rn,rt } => {
        ...
        Asm::LdpFpsimd { opc,imm7,rt2,rn,rt,class_selector } => {
        match class_selector {
        ...
        Asm::LdpGen { opc,imm7,rt2,rn,rt,class_selector } => {
        match class_selector {
        ...
        Asm::Ldpsw { imm7,rt2,rn,rt,class_selector } => {
        match class_selector {
        ...
        Asm::LdrImmFpsimd { size,opc,imm9,rn,rt,imm12,class_selector } => {
        match class_selector {
        ...
        Asm::LdrImmGen { size,imm9,rn,rt,imm12,class_selector } => {
        match class_selector {
        ...
        Asm::LdrRegFpsimd { size,opc,rm,option,s,rn,rt } => {
        ...
        Asm::LdrRegGen { size,rm,option,s,rn,rt } => {
        ...
        Asm::LdrbImm { imm9,rn,rt,imm12,class_selector } => {
        match class_selector {
        ...
        Asm::LdrhImm { imm9,rn,rt,imm12,class_selector } => {
        match class_selector {
        ...
        Asm::LdrsbImm { opc,imm9,rn,rt,imm12,class_selector } => {
        match class_selector {
        ...
        Asm::LdrsbReg { opc,rm,option,s,rn,rt } => {
        ...
        Asm::LdrshImm { opc,imm9,rn,rt,imm12,class_selector } => {
        match class_selector {
        ...
        Asm::LdrshReg { opc,rm,option,s,rn,rt } => {
        ...
        Asm::LdrswImm { imm9,rn,rt,imm12,class_selector } => {
        match class_selector {
        ...
        Asm::LdrswReg { rm,option,s,rn,rt } => {
        ...
        Asm::LdurFpsimd { size,opc,imm9,rn,rt } => {
        ...
        Asm::Ldxr { size,rn,rt } => {
        0b00_001000_0_1_0_0_00000_00000
        | (*size as u32) << 30
        | rn << 5
        | rt << 0
        }
        ...
        Asm::Ldxrh { rn,rt } => {
        0b01_001000_0_1_0_0_00000_00000
        | rn << 5
        | rt << 0
        }
        ...
        Asm::LsrUbfm { sf,n,immr,imms,rn,rd } => {
        ...
        Asm::MlaAdvsimdElt { q,size,l,m,rm,h,rn,rd } => {
        ...
        Asm::MlaAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        Asm::MlsAdvsimdElt { q,size,l,m,rm,h,rn,rd } => {
        ...
        Asm::MlsAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        Asm::MovOrrLogImm { sf,n,immr,imms,rd } => {
        ...
        Asm::MoviAdvsimd { q,op,a,b,c,cmode,d,e,f,g,h,rd } => {
        ...
        Asm::MsrReg { o0,op1,crn,crm,op2,rt } => {
        ...
        Asm::MulAdvsimdElt { q,size,l,m,rm,h,rn,rd } => {
        ...
        Asm::MulAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        0b0_0_1_01110_00_10000_00101_10_00000_00000
        | (*q as u32) << 30
        | rn << 5
        | rd << 0
        }
        Asm::MvnOrnLogShift { sf,shift,rm,imm6,rd } => {
        ...
        Asm::MvniAdvsimd { q,a,b,c,cmode,d,e,f,g,h,rd } => {
        0b0_0_1_0111100000_0_0_0_0000_0_1_0_0_0_0_0_00000
        | (*q as u32) << 30
        | (*a as u32) << 18
        | (*b as u32) << 17
        ...
        Asm::NegAdvsimd { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::NegSubAddsubShift { sf,shift,rm,imm6,rd } => {
        ...
        Asm::NegsSubsAddsubShift { sf,shift,rm,imm6 } => {
        ...
        Asm::NgcSbc { sf,rm,rd } => {
        0b0_1_0_11010000_00000_000000_11111_00000
        | (*sf as u32) << 31
        | rm << 16
        | rd << 0
        }
        Asm::NgcsSbcs { sf,rm,rd } => {
        0b0_1_1_11010000_00000_000000_11111_00000
        | (*sf as u32) << 31
        | rm << 16
        | rd << 0
        }
        ...
        Asm::OrnLogShift { sf,shift,rm,imm6,rn,rd } => {
        ...
        Asm::OrrAdvsimdImm { q,a,b,c,cmode,d,e,f,g,h,rd } => {
        0b0_0_0_0111100000_0_0_0_0000_0_1_0_0_0_0_0_00000
        | (*q as u32) << 30
        | (*a as u32) << 18
        | (*b as u32) << 17
        ...
        Asm::OrrLogImm { sf,n,immr,imms,rn,rd } => {
        ...
        Asm::OrrLogShift { sf,shift,rm,imm6,rn,rd } => {
        ...
        Asm::Pacda { z,rn,rd } => {
        0b1_1_0_11010110_00001_0_0_0_010_00000_00000
        | (*z as u32) << 13
        | rn << 5
        | rd << 0
        }
        Asm::Pacdb { z,rn,rd } => {
        0b1_1_0_11010110_00001_0_0_0_011_00000_00000
        | (*z as u32) << 13
        | rn << 5
        | rd << 0
        }
        Asm::Pacga { rm,rn,rd } => {
        0b1_0_0_11010110_00000_001100_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Pacia { z,rn,rd,crm,op2,class_selector } => {
        match class_selector {
        ...
        Asm::Pacib { z,rn,rd,crm,op2,class_selector } => {
        match class_selector {
        ...
        Asm::PmulAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::PmullAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::PssbbDsb {  } => {
        0b1101010100_0_00_011_0011_0100_1_00_11111
        }
        Asm::RaddhnAdvsimd { q,size,rm,rn,rd } => {
        ...
        0b11001110011_00000_1_0_00_11_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::RbitAdvsimd { q,rn,rd } => {
        0b0_0_1_01110_01_10000_00101_10_00000_00000
        | (*q as u32) << 30
        | rn << 5
        | rd << 0
        }
        ...
        Asm::Ret { rn } => {
        0b1101011_0_0_10_11111_0000_0_0_00000_00000
        | rn << 5
        }
        Asm::Reta { m } => {
        0b1101011_0_0_10_11111_0000_1_0_11111_11111
        | (*m as u32) << 10
        }
        ...
        0b0_1_0_11010110_00000_0000_01_00000_00000
        | (*sf as u32) << 31
        | rn << 5
        | rd << 0
        }
        ...
        Asm::Rev32Int { rn,rd } => {
        0b1_1_0_11010110_00000_0000_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::Rev64Rev { rn,rd } => {
        0b1_1_0_11010110_00000_0000_11_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::RorExtr { sf,n,rm,imms,rn,rd } => {
        0b0_00_100111_0_0_00000_000000_00000_00000
        | (*sf as u32) << 31
        | (*n as u32) << 22
        | rm << 16
        ...
        Asm::RsubhnAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SabaAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SabalAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SabdAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SabdlAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SaddlAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SaddwAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::Sb {  } => {
        0b1101010100_0_00_011_0011_1_11_11111
        }
        Asm::Sbc { sf,rm,rn,rd } => {
        ...
        Asm::SbfizSbfm { sf,n,immr,imms,rn,rd } => {
        0b0_00_100110_0_000000_000000_00000_00000
        | (*sf as u32) << 31
        | (*n as u32) << 22
        | (*immr as u32) << 16
        ...
        Asm::SbfxSbfm { sf,n,immr,imms,rn,rd } => {
        0b0_00_100110_0_000000_000000_00000_00000
        | (*sf as u32) << 31
        | (*n as u32) << 22
        | (*immr as u32) << 16
        ...
        Asm::ScvtfAdvsimdFix { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ScvtfAdvsimdFixSelector::Scalar => {
        0b01_0_111110_000_11100_1_00000_00000
        | (*immb as u32) << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::ScvtfAdvsimdInt { rn,rd,sz,q,class_selector } => {
        match class_selector {
        ScvtfAdvsimdIntSelector::ScalarHalfPrecision => {
        0b01_0_11110_0_111100_11101_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::ScvtfFloatFix { sf,ftype,scale,rn,rd } => {
        ...
        Asm::SdotAdvsimdElt { q,size,l,m,rm,h,rn,rd } => {
        ...
        Asm::SdotAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        Asm::Setf { sz,rn } => {
        0b0_0_1_11010000_000000_0_0010_00000_0_1101
        | (*sz as u32) << 14
        | rn << 5
        }
        Asm::Setgp { sz,rs,op2,rn,rd } => {
        ...
        0b01011110_00_0_00000_0_000_00_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Sha1hAdvsimd { rn,rd } => {
        0b01011110_00_10100_00000_10_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::Sha1mAdvsimd { rm,rn,rd } => {
        0b01011110_00_0_00000_0_010_00_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Sha1pAdvsimd { rm,rn,rd } => {
        0b01011110_00_0_00000_0_001_00_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Sha1su0Advsimd { rm,rn,rd } => {
        0b01011110_00_0_00000_0_011_00_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Sha1su1Advsimd { rn,rd } => {
        0b01011110_00_10100_00001_10_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::Sha256h2Advsimd { rm,rn,rd } => {
        0b01011110_00_0_00000_0_10_1_00_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Sha256hAdvsimd { rm,rn,rd } => {
        0b01011110_00_0_00000_0_10_0_00_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Sha256su0Advsimd { rn,rd } => {
        0b01011110_00_10100_00010_10_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::Sha256su1Advsimd { rm,rn,rd } => {
        0b01011110_00_0_00000_0_110_00_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Sha512h2Advsimd { rm,rn,rd } => {
        0b11001110011_00000_1_0_00_01_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Sha512hAdvsimd { rm,rn,rd } => {
        0b11001110011_00000_1_0_00_00_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Sha512su0Advsimd { rn,rd } => {
        0b11001110110000001000_00_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::Sha512su1Advsimd { rm,rn,rd } => {
        0b11001110011_00000_1_0_00_10_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::ShaddAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::ShlAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ShlAdvsimdSelector::Scalar => {
        0b01_0_111110_000_01010_1_00000_00000
        | (*immb as u32) << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::ShsubAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SliAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        SliAdvsimdSelector::Scalar => {
        0b01_1_111110_000_01010_1_00000_00000
        | (*immb as u32) << 16
        | rn << 5
        | rd << 0
        }
        ...
        0b11001110011_00000_1_1_00_00_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Sm3partw2Advsimd { rm,rn,rd } => {
        0b11001110011_00000_1_1_00_01_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::Sm3ss1Advsimd { rm,ra,rn,rd } => {
        0b110011100_10_00000_0_00000_00000_00000
        | rm << 16
        | ra << 10
        | rn << 5
        | rd << 0
        ...
        0b11001110110000001000_01_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::Sm4ekeyAdvsimd { rm,rn,rd } => {
        0b11001110011_00000_1_1_00_10_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::SmaxAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SmaxpAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::Smc { imm16 } => {
        0b11010100_000_0000000000000000_000_11
        | (*imm16 as u32) << 5
        }
        Asm::SminAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SminpAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SmlalAdvsimdElt { q,size,l,m,rm,h,rn,rd } => {
        ...
        Asm::SmlalAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        Asm::SmlslAdvsimdElt { q,size,l,m,rm,h,rn,rd } => {
        ...
        Asm::SmlslAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        0b0_1_0_01110_10_0_00000_1_010_0_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::SmneglSmsubl { rm,rn,rd } => {
        0b1_00_11011_0_01_00000_1_11111_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::Smulh { rm,rn,rd } => {
        0b1_00_11011_0_10_00000_0_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::SmullAdvsimdElt { q,size,l,m,rm,h,rn,rd } => {
        ...
        Asm::SmullAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        0b1_00_11011_0_01_00000_0_11111_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::SqabsAdvsimd { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqaddAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqdmlalAdvsimdElt { size,l,m,rm,h,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqdmlalAdvsimdVec { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqdmlslAdvsimdElt { size,l,m,rm,h,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqdmlslAdvsimdVec { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqdmulhAdvsimdElt { size,l,m,rm,h,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqdmulhAdvsimdVec { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqdmullAdvsimdElt { size,l,m,rm,h,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqdmullAdvsimdVec { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqnegAdvsimd { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqrdmlahAdvsimdElt { size,l,m,rm,h,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqrdmlahAdvsimdVec { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqrdmlshAdvsimdElt { size,l,m,rm,h,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqrdmlshAdvsimdVec { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqrdmulhAdvsimdElt { size,l,m,rm,h,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqrdmulhAdvsimdVec { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqrshlAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqrshrnAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqrshrunAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqshlAdvsimdImm { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqshlAdvsimdReg { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqshluAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqshrnAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqshrunAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqsubAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqxtnAdvsimd { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SqxtunAdvsimd { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SrhaddAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SriAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        SriAdvsimdSelector::Scalar => {
        0b01_1_111110_000_01000_1_00000_00000
        | (*immb as u32) << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::SrshlAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SrshrAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SrsraAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SshlAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SshrAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SsraAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SsublAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SsubwAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::St1AdvsimdMult { q,opcode,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::St1AdvsimdSngl { q,opcode,s,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::St2AdvsimdMult { q,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::St2AdvsimdSngl { q,opcode,s,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::St2g { imm9,xn,xt,class_selector } => {
        match class_selector {
        ...
        Asm::St3AdvsimdMult { q,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::St3AdvsimdSngl { q,opcode,s,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::St4AdvsimdMult { q,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::St4AdvsimdSngl { q,opcode,s,size,rn,rt,rm,class_selector } => {
        match class_selector {
        ...
        Asm::St64b { rn,rt } => {
        0b11_111_0_00_0_0_1_11111_1_001_00_00000_00000
        | rn << 5
        | rt << 0
        }
        Asm::St64bv { rs,rn,rt } => {
        0b11_111_0_00_0_0_1_00000_1_011_00_00000_00000
        | rs << 16
        | rn << 5
        | rt << 0
        }
        Asm::St64bv0 { rs,rn,rt } => {
        0b11_111_0_00_0_0_1_00000_1_010_00_00000_00000
        | rs << 16
        | rn << 5
        | rt << 0
        }
        ...
        0b01_111_0_00_0_0_1_00000_0_000_00_00000_11111
        | r << 22
        | rs << 16
        | rn << 5
        }
        ...
        0b01_111_0_00_0_0_1_00000_0_001_00_00000_11111
        | r << 22
        | rs << 16
        | rn << 5
        }
        ...
        0b01_111_0_00_0_0_1_00000_0_010_00_00000_11111
        | r << 22
        | rs << 16
        | rn << 5
        }
        Asm::Stg { imm9,xn,xt,class_selector } => {
        match class_selector {
        ...
        Asm::Stgp { simm7,xt2,xn,xt,class_selector } => {
        match class_selector {
        ...
        0b00_001000_1_0_0_0_00000_00000
        | (*size as u32) << 30
        | rn << 5
        | rt << 0
        }
        ...
        Asm::Stllrh { rn,rt } => {
        0b01_001000_1_0_0_0_00000_00000
        | rn << 5
        | rt << 0
        }
        Asm::Stlr { size,rn,rt } => {
        0b00_001000_1_0_0_1_00000_00000
        | (*size as u32) << 30
        | rn << 5
        | rt << 0
        }
        ...
        Asm::Stlrh { rn,rt } => {
        0b01_001000_1_0_0_1_00000_00000
        | rn << 5
        | rt << 0
        }
        ...
        Asm::Stlxrh { rs,rn,rt } => {
        0b01_001000_0_0_0_00000_1_00000_00000
        | rs << 16
        | rn << 5
        | rt << 0
        }
        Asm::StnpFpsimd { opc,imm7,rt2,rn,rt } => {
        ...
        Asm::StnpGen { opc,imm7,rt2,rn,rt } => {
        ...
        Asm::StpFpsimd { opc,imm7,rt2,rn,rt,class_selector } => {
        match class_selector {
        ...
        Asm::StpGen { opc,imm7,rt2,rn,rt,class_selector } => {
        match class_selector {
        ...
        Asm::StrImmFpsimd { size,opc,imm9,rn,rt,imm12,class_selector } => {
        match class_selector {
        ...
        Asm::StrImmGen { size,imm9,rn,rt,imm12,class_selector } => {
        match class_selector {
        ...
        Asm::StrRegFpsimd { size,opc,rm,option,s,rn,rt } => {
        0b00_111_1_00_00_1_00000_000_0_10_00000_00000
        | (*size as u32) << 30
        | (*opc as u32) << 22
        | rm << 16
        ...
        Asm::StrRegGen { size,rm,option,s,rn,rt } => {
        0b00_111_0_00_00_1_00000_000_0_10_00000_00000
        | (*size as u32) << 30
        | rm << 16
        | (*option as u32) << 13
        ...
        Asm::StrbImm { imm9,rn,rt,imm12,class_selector } => {
        match class_selector {
        ...
        Asm::StrhImm { imm9,rn,rt,imm12,class_selector } => {
        match class_selector {
        ...
        0b01_111_0_00_0_0_1_00000_0_011_00_00000_11111
        | r << 22
        | rs << 16
        | rn << 5
        }
        ...
        0b01_111_0_00_0_0_1_00000_0_100_00_00000_11111
        | r << 22
        | rs << 16
        | rn << 5
        }
        ...
        0b01_111_0_00_0_0_1_00000_0_101_00_00000_11111
        | r << 22
        | rs << 16
        | rn << 5
        }
        ...
        0b01_111_0_00_0_0_1_00000_0_110_00_00000_11111
        | r << 22
        | rs << 16
        | rn << 5
        }
        ...
        0b01_111_0_00_0_0_1_00000_0_111_00_00000_11111
        | r << 22
        | rs << 16
        | rn << 5
        }
        Asm::SturFpsimd { size,opc,imm9,rn,rt } => {
        0b00_111_1_00_00_0_000000000_00_00000_00000
        | (*size as u32) << 30
        | (*opc as u32) << 22
        | truncate_imm::<_, 9>(*imm9) << 12
        ...
        Asm::Stxrh { rs,rn,rt } => {
        0b01_001000_0_0_0_00000_0_00000_00000
        | rs << 16
        | rn << 5
        | rt << 0
        }
        Asm::Stz2g { imm9,xn,xt,class_selector } => {
        match class_selector {
        ...
        Asm::Stzg { imm9,xn,xt,class_selector } => {
        match class_selector {
        ...
        Asm::SubAddsubExt { sf,rm,option,imm3,rn,rd } => {
        ...
        Asm::SubAddsubImm { sf,sh,imm12,rn,rd } => {
        ...
        Asm::SubAddsubShift { sf,shift,rm,imm6,rn,rd } => {
        ...
        Asm::SubAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::SubhnAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::SubsAddsubExt { sf,rm,option,imm3,rn,rd } => {
        ...
        Asm::SubsAddsubImm { sf,sh,imm12,rn,rd } => {
        ...
        Asm::SubsAddsubShift { sf,shift,rm,imm6,rn,rd } => {
        ...
        Asm::SudotAdvsimdElt { q,l,m,rm,h,rn,rd } => {
        ...
        Asm::SuqaddAdvsimd { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::Svc { imm16 } => {
        0b11010100_000_0000000000000000_000_01
        | (*imm16 as u32) << 5
        }
        Asm::Swp { size,a,r,rs,rn,rt } => {
        ...
        Asm::SxtwSbfm { rn,rd } => {
        0b1_00_100110_1_000000_011111_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::Sys { op1,crn,crm,op2,rt } => {
        ...
        Asm::Trn1Advsimd { q,size,rm,rn,rd } => {
        ...
        Asm::Trn2Advsimd { q,size,rm,rn,rd } => {
        ...
        Asm::TstAndsLogImm { sf,n,immr,imms,rn } => {
        ...
        Asm::TstAndsLogShift { sf,shift,rm,imm6,rn } => {
        ...
        Asm::UabaAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UabalAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UabdAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UabdlAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UaddlAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UaddwAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UbfizUbfm { sf,n,immr,imms,rn,rd } => {
        0b0_10_100110_0_000000_000000_00000_00000
        | (*sf as u32) << 31
        | (*n as u32) << 22
        | (*immr as u32) << 16
        ...
        Asm::UbfxUbfm { sf,n,immr,imms,rn,rd } => {
        0b0_10_100110_0_000000_000000_00000_00000
        | (*sf as u32) << 31
        | (*n as u32) << 22
        | (*immr as u32) << 16
        ...
        Asm::UcvtfAdvsimdFix { immb,rn,rd,q,class_selector } => {
        match class_selector {
        UcvtfAdvsimdFixSelector::Scalar => {
        0b01_1_111110_000_11100_1_00000_00000
        | (*immb as u32) << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::UcvtfAdvsimdInt { rn,rd,sz,q,class_selector } => {
        match class_selector {
        UcvtfAdvsimdIntSelector::ScalarHalfPrecision => {
        0b01_1_11110_0_111100_11101_10_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::UcvtfFloatFix { sf,ftype,scale,rn,rd } => {
        ...
        0b0000000000000000_0000000000000000
        | (*imm16 as u32) << 0
        }
        ...
        Asm::UdotAdvsimdElt { q,size,l,m,rm,h,rn,rd } => {
        ...
        Asm::UdotAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        Asm::UhaddAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UhsubAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UmaxAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UmaxpAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UminAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UminpAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UmlalAdvsimdElt { q,size,l,m,rm,h,rn,rd } => {
        ...
        Asm::UmlalAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        Asm::UmlslAdvsimdElt { q,size,l,m,rm,h,rn,rd } => {
        ...
        Asm::UmlslAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        0b0_1_1_01110_10_0_00000_1_010_0_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::UmneglUmsubl { rm,rn,rd } => {
        0b1_00_11011_1_01_00000_1_11111_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        ...
        Asm::Umulh { rm,rn,rd } => {
        0b1_00_11011_1_10_00000_0_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::UmullAdvsimdElt { q,size,l,m,rm,h,rn,rd } => {
        ...
        Asm::UmullAdvsimdVec { q,size,rm,rn,rd } => {
        ...
        0b1_00_11011_1_01_00000_0_11111_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::UqaddAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UqrshlAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UqrshrnAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UqshlAdvsimdImm { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UqshlAdvsimdReg { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UqshrnAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UqsubAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UqxtnAdvsimd { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UrhaddAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UrshlAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UrshrAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UrsraAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UsdotAdvsimdElt { q,l,m,rm,h,rn,rd } => {
        ...
        Asm::UshlAdvsimd { size,rm,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UshrAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        0b0_1_0_01110_10_0_00000_1_010_1_1_00000_00000
        | rm << 16
        | rn << 5
        | rd << 0
        }
        Asm::UsqaddAdvsimd { size,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UsraAdvsimd { immb,rn,rd,q,class_selector } => {
        match class_selector {
        ...
        Asm::UsublAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UsubwAdvsimd { q,size,rm,rn,rd } => {
        ...
        Asm::UxtbUbfm { rn,rd } => {
        0b0_10_100110_0_000000_000111_00000_00000
        | rn << 5
        | rd << 0
        }
        Asm::UxthUbfm { rn,rd } => {
        0b0_10_100110_0_000000_001111_00000_00000
        | rn << 5
        | rd << 0
        }
        ...
        Asm::Uzp1Advsimd { q,size,rm,rn,rd } => {
        ...
        Asm::Uzp2Advsimd { q,size,rm,rn,rd } => {
        ...
        Asm::Wfet { rd } => {
        0b11010101000000110001_0000_000_00000
        | rd << 0
        }
        Asm::Wfi {  } => {
        ...
        Asm::Wfit { rd } => {
        0b11010101000000110001_0000_001_00000
        | rd << 0
        }
        Asm::Xaflag {  } => {
        0b1101010100_0_00_000_0100_001_11111
        }
        ...
        Asm::Xpac { d,rd,class_selector } => {
        match class_selector {
        XpacSelector::Integer => {
        0b1_1_0_11010110_00001_0_1_000_0_11111_00000
        | (*d as u32) << 10
        | rd << 0
        }
        XpacSelector::System => {
        0b1101010100_0_00_011_0010_0000_111_11111
        }
        }
        }
        ...
        Asm::Zip1Advsimd { q,size,rm,rn,rd } => {
        ...
        Asm::Zip2Advsimd { q,size,rm,rn,rd } => {
