...
// ${chalk.green('http')} POST https://instarest.io/api name="my-api"

const tutorial = `\
Thanks for signing up for instarest. You now have a fully working rest api. Your api has lots of features, too many to show just now, but here are some of the basics.

    ${chalk.blue('Get collection of entities')}
    ${chalk.green('GET')} https://instarest.io/api/my-api/:entity 

    ${chalk.blue('Get single entity')}
    ${chalk.green('GET')} https://instarest.io/api/my-api/:entity/:id 

    ${chalk.blue('Update entity (full)')}
    ${chalk.green('PUT')} https://instarest.io/api/my-api/:entity/:id 

    ${chalk.blue('Update entity (partial)')}
    ${chalk.green('PATCH')} https://instarest.io/api/my-api/:entity/:id 

    ${chalk.blue('Create new entity')}
    ${chalk.green('POST')} https://instarest.io/api/my-api/:entity 

    ${chalk.blue('Delete an entity')}
    ${chalk.green('DELETE')} https://instarest.io/api/my-api/:entity/:id
...
1) Read our documentation [https://instarest.io/docs]
2) Follow the interactive tutorial. 

  ${chalk.green('http')} https://instarest.io/api/my-api/_tutorial
  ...
  ${chalk.green('http')} post https://instarest.io/api/my-api/_account emailAddress="example@example.com"
`
