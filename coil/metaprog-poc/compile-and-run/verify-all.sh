...
# 2. parity       — 112-file corpus: emit-ir output AND diagnostics byte-identical
...
echo "=========== 2/3 engine parity (compiled vs interpreter, byte-exact) ==========="
metaprog-poc/compile-and-run/parity.sh "$COIL" | tail -1 || { echo "PARITY FAILED"; exit 1; }
