...
## Build it
    ...
    build/examples/mini-scheme < src/apps/mini-scheme/tests/fib.scm
...
The historical comparison used hyperfine, Chez, and Petite. Mini-scheme is a naive tree-walking
