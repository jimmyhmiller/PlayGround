...
# Run from the REPO ROOT (imports resolve relative to CWD):  tests/metaprogramming/compile-and-run/run.sh [coil-binary]
set -uo pipefail
cd "$(dirname "$0")/../../../.."
...
echo "=== 3. the same, through the REAL code-* library (src/compiler/codelib.coil):"
