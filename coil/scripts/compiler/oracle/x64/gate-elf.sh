...
#
# src/compiler/elf_selftest.coil hand-assembles
...
#
# Usage: scripts/compiler/oracle/x64/gate-elf.sh <coil-binary>
set -uo pipefail
cd "$(dirname "$0")/../../../.."
...
"$BIN" run src/compiler/elf_selftest.coil -- "$OBJ" >/dev/null || {
