#!/usr/bin/env bash
# Compile-speed-at-scale: the honest §12 risk (docs/design/FUTURE_WORK.md) — whole-program
...
# pipeline + link).
#
#   scripts/benchmarks/compile_scale.sh                 # default sizes
#   scripts/benchmarks/compile_scale.sh 500 2000 8000   # custom function counts
set -euo pipefail
cd "$(dirname "$0")/../.."
...
RESULTS="src/benchmarks/COMPILE_SCALE.md"
{
