...
```sh
paredit-like balance docs/repro/paredit-balance-coil/input.coil --diff
```
...
```sh
coil check docs/repro/paredit-balance-coil/input.coil     # unclosed `(`, expected
coil check docs/repro/paredit-balance-coil/expected.coil  # succeeds
coil check docs/repro/paredit-balance-coil/actual.coil    # fails after unwanted rewrite
```
