                    ...
                    (regions
                      (region
                        (block [^bb0]
                          ...
                          (operation
                            (name pdl.pattern)
                            (attributes {:benefit (: 1 i16) :sym_name @replace_addi})
                            (regions
                              (region
                                (block
                                  (arguments [])
                                      ...
                                      (region
                                        (block
                                          ...
                                          (operation
                                            ...
                                            (result-types !pdl.operation)
                                            (operands %1 %2 %3)
                                            (attributes {:attributeValueNames [] :opName "arith.muli" :operandSegmentSizes array<i32: 2, 0, 1>}))
                                          (operation
                                            (name pdl.replace)
                                            (operands %4 %5)
                              ...
                              (region
                                (block [^bb0]
                                  ...
                                  (operation
                                    ...
                                    (operands %arg2)
                                    (attributes {:pattern_name @replace_addi}))
                                  (operation
