...
Entry:
  ...
  store ptr %2, ptr %52, align 8, !dbg !532
    #dbg_declare(ptr %52, !533, !DIExpression(), !532)
  store ptr %3, ptr %51, align 8, !dbg !532
    #dbg_declare(ptr %51, !534, !DIExpression(), !532)
  %53 = icmp eq ptr %2, null, !dbg !535
  br i1 %53, label %Then, label %Else, !dbg !537

Block:                                            ; preds = %Else1
  %54 = call ptr @value_get_list(ptr align 1 %2, ptr readonly align 1 %3), !dbg !539
  %55 = icmp ne ptr %54, null, !dbg !539
  br i1 %55, label %Then2, label %Else2, !dbg !539

Block1:                                           ; preds = %Else, %Then
  %56 = phi i1 [ true, %Then ], [ %57, %Else ], !dbg !535
  br i1 %56, label %Then1, label %Else1, !dbg !535

Then:                                             ; preds = %Entry
  br label %Block1, !dbg !541

Else:                                             ; preds = %Entry
  %57 = icmp eq ptr %3, null, !dbg !541
  br label %Block1, !dbg !541
...
Block2:                                           ; preds = %Then2
  %58 = phi ptr [ %54, %Then2 ], !dbg !546
  store ptr %58, ptr %50, align 8, !dbg !546
    #dbg_declare(ptr %50, !547, !DIExpression(), !546)
  %59 = call i64 @vector_value_len(ptr readonly align 1 %58), !dbg !548
  store i64 %59, ptr %49, align 8, !dbg !548
    #dbg_declare(ptr %49, !549, !DIExpression(), !548)
  %60 = icmp ult i64 %59, 3, !dbg !550
  br i1 %60, label %Then3, label %Else3, !dbg !550

Then2:                                            ; preds = %Block
  br label %Block2, !dbg !552

Else2:                                            ; preds = %Block
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !554
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @1, i64 16, i1 false), !dbg !554
  ret void, !dbg !554

Block3:                                           ; preds = %Else3
  %61 = call ptr @vector_value_at(ptr readonly align 1 %58, i64 0), !dbg !555
  store ptr %61, ptr %48, align 8, !dbg !555
    #dbg_declare(ptr %48, !556, !DIExpression(), !555)
  %62 = call ptr @vector_value_at(ptr readonly align 1 %58, i64 1), !dbg !557
  store ptr %62, ptr %47, align 8, !dbg !557
    #dbg_declare(ptr %47, !558, !DIExpression(), !557)
  %63 = call ptr @vector_value_at(ptr readonly align 1 %58, i64 2), !dbg !559
  store ptr %63, ptr %46, align 8, !dbg !559
    #dbg_declare(ptr %46, !560, !DIExpression(), !559)
  %64 = call ptr @value_get_atom(ptr align 1 %2, ptr readonly align 1 %61), !dbg !561
  store ptr %64, ptr %45, align 8, !dbg !561
    #dbg_declare(ptr %45, !562, !DIExpression(), !561)
  %65 = call ptr @value_create_identifier(ptr align 1 %2, ptr nonnull readonly align 1 @__anon_1817), !dbg !563
  %66 = icmp ne ptr %65, null, !dbg !563
  br i1 %66, label %Then4, label %Else4, !dbg !563

Then3:                                            ; preds = %Block2
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !565
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !567
...
Block4:                                           ; preds = %Then4
  %67 = phi ptr [ %65, %Then4 ], !dbg !570
  store ptr %67, ptr %44, align 8, !dbg !570
    #dbg_declare(ptr %44, !571, !DIExpression(), !570)
  %68 = call ptr @value_create_identifier(ptr align 1 %2, ptr nonnull readonly align 1 @__anon_1828), !dbg !572
  %69 = icmp ne ptr %68, null, !dbg !572
  br i1 %69, label %Then5, label %Else5, !dbg !572

Then4:                                            ; preds = %Block3
  br label %Block4, !dbg !574

Else4:                                            ; preds = %Block3
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !576
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !577
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !578
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !578
  ret void, !dbg !578

Block5:                                           ; preds = %Then5
  %70 = phi ptr [ %68, %Then5 ], !dbg !579
  store ptr %70, ptr %43, align 8, !dbg !579
    #dbg_declare(ptr %43, !580, !DIExpression(), !579)
  %71 = call ptr @value_create_identifier(ptr align 1 %2, ptr nonnull readonly align 1 @__anon_1831), !dbg !581
  %72 = icmp ne ptr %71, null, !dbg !581
  br i1 %72, label %Then6, label %Else6, !dbg !581

Then5:                                            ; preds = %Block4
  br label %Block5, !dbg !583

Else5:                                            ; preds = %Block4
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !585
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !586
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !587
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !587
  ret void, !dbg !587

Block6:                                           ; preds = %Then6
  %73 = phi ptr [ %71, %Then6 ], !dbg !588
  store ptr %73, ptr %42, align 8, !dbg !588
    #dbg_declare(ptr %42, !589, !DIExpression(), !588)
  %74 = call ptr @vector_value_create(ptr align 1 %2), !dbg !590
  %75 = icmp ne ptr %74, null, !dbg !590
  br i1 %75, label %Then7, label %Else7, !dbg !590

Then6:                                            ; preds = %Block5
  br label %Block6, !dbg !592

Else6:                                            ; preds = %Block5
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !594
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !595
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !596
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !596
  ret void, !dbg !596

Block7:                                           ; preds = %Then7
  %76 = phi ptr [ %74, %Then7 ], !dbg !597
  store ptr %76, ptr %41, align 8, !dbg !597
    #dbg_declare(ptr %41, !598, !DIExpression(), !597)
  %77 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %76, ptr align 1 %70), !dbg !599
  %78 = icmp ne ptr %77, null, !dbg !599
  br i1 %78, label %Then8, label %Else8, !dbg !599

Then7:                                            ; preds = %Block6
  br label %Block7, !dbg !601

Else7:                                            ; preds = %Block6
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !603
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !604
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !605
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !605
  ret void, !dbg !605

Block8:                                           ; preds = %Then8
  %79 = phi ptr [ %77, %Then8 ], !dbg !606
  store ptr %79, ptr %40, align 8, !dbg !606
    #dbg_declare(ptr %40, !607, !DIExpression(), !606)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %76), !dbg !608
  %80 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %79, ptr align 1 %73), !dbg !609
  %81 = icmp ne ptr %80, null, !dbg !609
  br i1 %81, label %Then9, label %Else9, !dbg !609

Then8:                                            ; preds = %Block7
  br label %Block8, !dbg !611

Else8:                                            ; preds = %Block7
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !613
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !614
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !615
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !615
  ret void, !dbg !615

Block9:                                           ; preds = %Then9
  %82 = phi ptr [ %80, %Then9 ], !dbg !616
  store ptr %82, ptr %39, align 8, !dbg !616
    #dbg_declare(ptr %39, !617, !DIExpression(), !616)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %79), !dbg !618
  %83 = call ptr @value_create_list(ptr align 1 %2, ptr align 1 %82), !dbg !619
  %84 = icmp ne ptr %83, null, !dbg !619
  br i1 %84, label %Then10, label %Else10, !dbg !619

Then9:                                            ; preds = %Block8
  br label %Block9, !dbg !621

Else9:                                            ; preds = %Block8
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !623
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !624
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !625
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !625
  ret void, !dbg !625

Block10:                                          ; preds = %Then10
  %85 = phi ptr [ %83, %Then10 ], !dbg !626
  store ptr %85, ptr %38, align 8, !dbg !626
    #dbg_declare(ptr %38, !627, !DIExpression(), !626)
  %86 = call ptr @value_create_identifier(ptr align 1 %2, ptr nonnull readonly align 1 @__anon_1835), !dbg !628
  %87 = icmp ne ptr %86, null, !dbg !628
  br i1 %87, label %Then11, label %Else11, !dbg !628

Then10:                                           ; preds = %Block9
  br label %Block10, !dbg !630

Else10:                                           ; preds = %Block9
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !632
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !633
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !634
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !634
  ret void, !dbg !634

Block11:                                          ; preds = %Then11
  %88 = phi ptr [ %86, %Then11 ], !dbg !635
  store ptr %88, ptr %37, align 8, !dbg !635
    #dbg_declare(ptr %37, !636, !DIExpression(), !635)
  %89 = call ptr @value_create_identifier(ptr align 1 %2, ptr nonnull readonly align 1 @__anon_1840), !dbg !637
  %90 = icmp ne ptr %89, null, !dbg !637
  br i1 %90, label %Then12, label %Else12, !dbg !637

Then11:                                           ; preds = %Block10
  br label %Block11, !dbg !639

Else11:                                           ; preds = %Block10
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !641
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !642
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !643
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !643
  ret void, !dbg !643

Block12:                                          ; preds = %Then12
  %91 = phi ptr [ %89, %Then12 ], !dbg !644
  store ptr %91, ptr %36, align 8, !dbg !644
    #dbg_declare(ptr %36, !645, !DIExpression(), !644)
  %92 = call ptr @vector_value_create(ptr align 1 %2), !dbg !646
  %93 = icmp ne ptr %92, null, !dbg !646
  br i1 %93, label %Then13, label %Else13, !dbg !646

Then12:                                           ; preds = %Block11
  br label %Block12, !dbg !648

Else12:                                           ; preds = %Block11
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !650
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !651
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !652
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !652
  ret void, !dbg !652

Block13:                                          ; preds = %Then13
  %94 = phi ptr [ %92, %Then13 ], !dbg !653
  store ptr %94, ptr %35, align 8, !dbg !653
    #dbg_declare(ptr %35, !654, !DIExpression(), !653)
  %95 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %94, ptr align 1 %91), !dbg !655
  %96 = icmp ne ptr %95, null, !dbg !655
  br i1 %96, label %Then14, label %Else14, !dbg !655

Then13:                                           ; preds = %Block12
  br label %Block13, !dbg !657

Else13:                                           ; preds = %Block12
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !659
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !660
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !661
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !661
  ret void, !dbg !661

Block14:                                          ; preds = %Then14
  %97 = phi ptr [ %95, %Then14 ], !dbg !662
  store ptr %97, ptr %34, align 8, !dbg !662
    #dbg_declare(ptr %34, !663, !DIExpression(), !662)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %94), !dbg !664
  %98 = call ptr @value_create_list(ptr align 1 %2, ptr align 1 %97), !dbg !665
  %99 = icmp ne ptr %98, null, !dbg !665
  br i1 %99, label %Then15, label %Else15, !dbg !665

Then14:                                           ; preds = %Block13
  br label %Block14, !dbg !667

Else14:                                           ; preds = %Block13
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !669
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !670
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !671
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !671
  ret void, !dbg !671

Block15:                                          ; preds = %Then15
  %100 = phi ptr [ %98, %Then15 ], !dbg !672
  store ptr %100, ptr %33, align 8, !dbg !672
    #dbg_declare(ptr %33, !673, !DIExpression(), !672)
  %101 = call ptr @vector_value_create(ptr align 1 %2), !dbg !674
  %102 = icmp ne ptr %101, null, !dbg !674
  br i1 %102, label %Then16, label %Else16, !dbg !674

Then15:                                           ; preds = %Block14
  br label %Block15, !dbg !676

Else15:                                           ; preds = %Block14
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !678
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !679
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !680
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !680
  ret void, !dbg !680

Block16:                                          ; preds = %Then16
  %103 = phi ptr [ %101, %Then16 ], !dbg !681
  store ptr %103, ptr %32, align 8, !dbg !681
    #dbg_declare(ptr %32, !682, !DIExpression(), !681)
  %104 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %103, ptr align 1 %88), !dbg !683
  %105 = icmp ne ptr %104, null, !dbg !683
  br i1 %105, label %Then17, label %Else17, !dbg !683

Then16:                                           ; preds = %Block15
  br label %Block16, !dbg !685

Else16:                                           ; preds = %Block15
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !687
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !688
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !689
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !689
  ret void, !dbg !689

Block17:                                          ; preds = %Then17
  %106 = phi ptr [ %104, %Then17 ], !dbg !690
  store ptr %106, ptr %31, align 8, !dbg !690
    #dbg_declare(ptr %31, !691, !DIExpression(), !690)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %103), !dbg !692
  %107 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %106, ptr align 1 %100), !dbg !693
  %108 = icmp ne ptr %107, null, !dbg !693
  br i1 %108, label %Then18, label %Else18, !dbg !693

Then17:                                           ; preds = %Block16
  br label %Block17, !dbg !695

Else17:                                           ; preds = %Block16
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !697
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !698
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !699
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !699
  ret void, !dbg !699

Block18:                                          ; preds = %Then18
  %109 = phi ptr [ %107, %Then18 ], !dbg !700
  store ptr %109, ptr %30, align 8, !dbg !700
    #dbg_declare(ptr %30, !701, !DIExpression(), !700)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %106), !dbg !702
  %110 = call ptr @value_create_list(ptr align 1 %2, ptr align 1 %109), !dbg !703
  %111 = icmp ne ptr %110, null, !dbg !703
  br i1 %111, label %Then19, label %Else19, !dbg !703

Then18:                                           ; preds = %Block17
  br label %Block18, !dbg !705

Else18:                                           ; preds = %Block17
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !707
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !708
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !709
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !709
  ret void, !dbg !709

Block19:                                          ; preds = %Then19
  %112 = phi ptr [ %110, %Then19 ], !dbg !710
  store ptr %112, ptr %29, align 8, !dbg !710
    #dbg_declare(ptr %29, !711, !DIExpression(), !710)
  %113 = call ptr @value_create_identifier(ptr align 1 %2, ptr nonnull readonly align 1 @__anon_1845), !dbg !712
  %114 = icmp ne ptr %113, null, !dbg !712
  br i1 %114, label %Then20, label %Else20, !dbg !712

Then19:                                           ; preds = %Block18
  br label %Block19, !dbg !714

Else19:                                           ; preds = %Block18
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !716
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !717
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !718
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !718
  ret void, !dbg !718

Block20:                                          ; preds = %Then20
  %115 = phi ptr [ %113, %Then20 ], !dbg !719
  store ptr %115, ptr %28, align 8, !dbg !719
    #dbg_declare(ptr %28, !720, !DIExpression(), !719)
  %116 = call ptr @value_create_type_expr(ptr align 1 %2, ptr align 1 %63), !dbg !721
  %117 = icmp ne ptr %116, null, !dbg !721
  br i1 %117, label %Then21, label %Else21, !dbg !721

Then20:                                           ; preds = %Block19
  br label %Block20, !dbg !723

Else20:                                           ; preds = %Block19
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !725
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !726
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !727
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !727
  ret void, !dbg !727

Block21:                                          ; preds = %Then21
  %118 = phi ptr [ %116, %Then21 ], !dbg !728
  store ptr %118, ptr %27, align 8, !dbg !728
    #dbg_declare(ptr %27, !729, !DIExpression(), !728)
  %119 = call ptr @vector_value_create(ptr align 1 %2), !dbg !730
  %120 = icmp ne ptr %119, null, !dbg !730
  br i1 %120, label %Then22, label %Else22, !dbg !730

Then21:                                           ; preds = %Block20
  br label %Block21, !dbg !732

Else21:                                           ; preds = %Block20
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !734
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !735
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !736
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !736
  ret void, !dbg !736

Block22:                                          ; preds = %Then22
  %121 = phi ptr [ %119, %Then22 ], !dbg !737
  store ptr %121, ptr %26, align 8, !dbg !737
    #dbg_declare(ptr %26, !738, !DIExpression(), !737)
  %122 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %121, ptr align 1 %115), !dbg !739
  %123 = icmp ne ptr %122, null, !dbg !739
  br i1 %123, label %Then23, label %Else23, !dbg !739

Then22:                                           ; preds = %Block21
  br label %Block22, !dbg !741

Else22:                                           ; preds = %Block21
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !743
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !744
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !745
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !745
  ret void, !dbg !745

Block23:                                          ; preds = %Then23
  %124 = phi ptr [ %122, %Then23 ], !dbg !746
  store ptr %124, ptr %25, align 8, !dbg !746
    #dbg_declare(ptr %25, !747, !DIExpression(), !746)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %121), !dbg !748
  %125 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %124, ptr align 1 %118), !dbg !749
  %126 = icmp ne ptr %125, null, !dbg !749
  br i1 %126, label %Then24, label %Else24, !dbg !749

Then23:                                           ; preds = %Block22
  br label %Block23, !dbg !751

Else23:                                           ; preds = %Block22
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !753
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !754
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !755
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !755
  ret void, !dbg !755

Block24:                                          ; preds = %Then24
  %127 = phi ptr [ %125, %Then24 ], !dbg !756
  store ptr %127, ptr %24, align 8, !dbg !756
    #dbg_declare(ptr %24, !757, !DIExpression(), !756)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %124), !dbg !758
  %128 = call ptr @value_create_list(ptr align 1 %2, ptr align 1 %127), !dbg !759
  %129 = icmp ne ptr %128, null, !dbg !759
  br i1 %129, label %Then25, label %Else25, !dbg !759

Then24:                                           ; preds = %Block23
  br label %Block24, !dbg !761

Else24:                                           ; preds = %Block23
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !763
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !764
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !765
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !765
  ret void, !dbg !765

Block25:                                          ; preds = %Then25
  %130 = phi ptr [ %128, %Then25 ], !dbg !766
  store ptr %130, ptr %23, align 8, !dbg !766
    #dbg_declare(ptr %23, !767, !DIExpression(), !766)
  %131 = call ptr @value_create_identifier(ptr align 1 %2, ptr nonnull readonly align 1 @__anon_1852), !dbg !768
  %132 = icmp ne ptr %131, null, !dbg !768
  br i1 %132, label %Then26, label %Else26, !dbg !768

Then25:                                           ; preds = %Block24
  br label %Block25, !dbg !770

Else25:                                           ; preds = %Block24
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !772
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !773
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !774
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !774
  ret void, !dbg !774

Block26:                                          ; preds = %Then26
  %133 = phi ptr [ %131, %Then26 ], !dbg !775
  store ptr %133, ptr %22, align 8, !dbg !775
    #dbg_declare(ptr %22, !776, !DIExpression(), !775)
  %134 = call ptr @value_create_keyword(ptr align 1 %2, ptr nonnull readonly align 1 @__anon_1859), !dbg !777
  %135 = icmp ne ptr %134, null, !dbg !777
  br i1 %135, label %Then27, label %Else27, !dbg !777

Then26:                                           ; preds = %Block25
  br label %Block26, !dbg !779

Else26:                                           ; preds = %Block25
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !781
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !782
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !783
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !783
  ret void, !dbg !783

Block27:                                          ; preds = %Then27
  %136 = phi ptr [ %134, %Then27 ], !dbg !784
  store ptr %136, ptr %21, align 8, !dbg !784
    #dbg_declare(ptr %21, !785, !DIExpression(), !784)
  %137 = call ptr @vector_value_create(ptr align 1 %2), !dbg !786
  %138 = icmp ne ptr %137, null, !dbg !786
  br i1 %138, label %Then28, label %Else28, !dbg !786

Then27:                                           ; preds = %Block26
  br label %Block27, !dbg !788

Else27:                                           ; preds = %Block26
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !790
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !791
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !792
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !792
  ret void, !dbg !792

Block28:                                          ; preds = %Then28
  %139 = phi ptr [ %137, %Then28 ], !dbg !793
  store ptr %139, ptr %20, align 8, !dbg !793
    #dbg_declare(ptr %20, !794, !DIExpression(), !793)
  %140 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %139, ptr align 1 %136), !dbg !795
  %141 = icmp ne ptr %140, null, !dbg !795
  br i1 %141, label %Then29, label %Else29, !dbg !795

Then28:                                           ; preds = %Block27
  br label %Block28, !dbg !797

Else28:                                           ; preds = %Block27
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !799
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !800
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !801
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !801
  ret void, !dbg !801

Block29:                                          ; preds = %Then29
  %142 = phi ptr [ %140, %Then29 ], !dbg !802
  store ptr %142, ptr %19, align 8, !dbg !802
    #dbg_declare(ptr %19, !803, !DIExpression(), !802)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %139), !dbg !804
  %143 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %142, ptr align 1 %62), !dbg !805
  %144 = icmp ne ptr %143, null, !dbg !805
  br i1 %144, label %Then30, label %Else30, !dbg !805

Then29:                                           ; preds = %Block28
  br label %Block29, !dbg !807

Else29:                                           ; preds = %Block28
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !809
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !810
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !811
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !811
  ret void, !dbg !811

Block30:                                          ; preds = %Then30
  %145 = phi ptr [ %143, %Then30 ], !dbg !812
  store ptr %145, ptr %18, align 8, !dbg !812
    #dbg_declare(ptr %18, !813, !DIExpression(), !812)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %142), !dbg !814
  %146 = call ptr @value_create_map(ptr align 1 %2, ptr align 1 %145), !dbg !815
  %147 = icmp ne ptr %146, null, !dbg !815
  br i1 %147, label %Then31, label %Else31, !dbg !815

Then30:                                           ; preds = %Block29
  br label %Block30, !dbg !817

Else30:                                           ; preds = %Block29
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !819
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !820
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !821
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !821
  ret void, !dbg !821

Block31:                                          ; preds = %Then31
  %148 = phi ptr [ %146, %Then31 ], !dbg !822
  store ptr %148, ptr %17, align 8, !dbg !822
    #dbg_declare(ptr %17, !823, !DIExpression(), !822)
  %149 = call ptr @vector_value_create(ptr align 1 %2), !dbg !824
  %150 = icmp ne ptr %149, null, !dbg !824
  br i1 %150, label %Then32, label %Else32, !dbg !824

Then31:                                           ; preds = %Block30
  br label %Block31, !dbg !826

Else31:                                           ; preds = %Block30
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !828
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !829
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !830
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !830
  ret void, !dbg !830

Block32:                                          ; preds = %Then32
  %151 = phi ptr [ %149, %Then32 ], !dbg !831
  store ptr %151, ptr %16, align 8, !dbg !831
    #dbg_declare(ptr %16, !832, !DIExpression(), !831)
  %152 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %151, ptr align 1 %133), !dbg !833
  %153 = icmp ne ptr %152, null, !dbg !833
  br i1 %153, label %Then33, label %Else33, !dbg !833

Then32:                                           ; preds = %Block31
  br label %Block32, !dbg !835

Else32:                                           ; preds = %Block31
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !837
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !838
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !839
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !839
  ret void, !dbg !839

Block33:                                          ; preds = %Then33
  %154 = phi ptr [ %152, %Then33 ], !dbg !840
  store ptr %154, ptr %15, align 8, !dbg !840
    #dbg_declare(ptr %15, !841, !DIExpression(), !840)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %151), !dbg !842
  %155 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %154, ptr align 1 %148), !dbg !843
  %156 = icmp ne ptr %155, null, !dbg !843
  br i1 %156, label %Then34, label %Else34, !dbg !843

Then33:                                           ; preds = %Block32
  br label %Block33, !dbg !845

Else33:                                           ; preds = %Block32
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !847
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !848
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !849
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !849
  ret void, !dbg !849

Block34:                                          ; preds = %Then34
  %157 = phi ptr [ %155, %Then34 ], !dbg !850
  store ptr %157, ptr %14, align 8, !dbg !850
    #dbg_declare(ptr %14, !851, !DIExpression(), !850)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %154), !dbg !852
  %158 = call ptr @value_create_list(ptr align 1 %2, ptr align 1 %157), !dbg !853
  %159 = icmp ne ptr %158, null, !dbg !853
  br i1 %159, label %Then35, label %Else35, !dbg !853

Then34:                                           ; preds = %Block33
  br label %Block34, !dbg !855

Else34:                                           ; preds = %Block33
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !857
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !858
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !859
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !859
  ret void, !dbg !859

Block35:                                          ; preds = %Then35
  %160 = phi ptr [ %158, %Then35 ], !dbg !860
  store ptr %160, ptr %13, align 8, !dbg !860
    #dbg_declare(ptr %13, !861, !DIExpression(), !860)
  %161 = call ptr @vector_value_create(ptr align 1 %2), !dbg !862
  %162 = icmp ne ptr %161, null, !dbg !862
  br i1 %162, label %Then36, label %Else36, !dbg !862

Then35:                                           ; preds = %Block34
  br label %Block35, !dbg !864

Else35:                                           ; preds = %Block34
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !866
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !867
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !868
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !868
  ret void, !dbg !868

Block36:                                          ; preds = %Then36
  %163 = phi ptr [ %161, %Then36 ], !dbg !869
  store ptr %163, ptr %12, align 8, !dbg !869
    #dbg_declare(ptr %12, !870, !DIExpression(), !869)
  %164 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %163, ptr align 1 %67), !dbg !871
  %165 = icmp ne ptr %164, null, !dbg !871
  br i1 %165, label %Then37, label %Else37, !dbg !871

Then36:                                           ; preds = %Block35
  br label %Block36, !dbg !873

Else36:                                           ; preds = %Block35
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !875
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !876
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !877
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !877
  ret void, !dbg !877

Block37:                                          ; preds = %Then37
  %166 = phi ptr [ %164, %Then37 ], !dbg !878
  store ptr %166, ptr %11, align 8, !dbg !878
    #dbg_declare(ptr %11, !879, !DIExpression(), !878)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %163), !dbg !880
  %167 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %166, ptr align 1 %85), !dbg !881
  %168 = icmp ne ptr %167, null, !dbg !881
  br i1 %168, label %Then38, label %Else38, !dbg !881

Then37:                                           ; preds = %Block36
  br label %Block37, !dbg !883

Else37:                                           ; preds = %Block36
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !885
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !886
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !887
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !887
  ret void, !dbg !887

Block38:                                          ; preds = %Then38
  %169 = phi ptr [ %167, %Then38 ], !dbg !888
  store ptr %169, ptr %10, align 8, !dbg !888
    #dbg_declare(ptr %10, !889, !DIExpression(), !888)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %166), !dbg !890
  %170 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %169, ptr align 1 %112), !dbg !891
  %171 = icmp ne ptr %170, null, !dbg !891
  br i1 %171, label %Then39, label %Else39, !dbg !891

Then38:                                           ; preds = %Block37
  br label %Block38, !dbg !893

Else38:                                           ; preds = %Block37
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !895
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !896
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !897
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !897
  ret void, !dbg !897

Block39:                                          ; preds = %Then39
  %172 = phi ptr [ %170, %Then39 ], !dbg !898
  store ptr %172, ptr %9, align 8, !dbg !898
    #dbg_declare(ptr %9, !899, !DIExpression(), !898)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %169), !dbg !900
  %173 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %172, ptr align 1 %130), !dbg !901
  %174 = icmp ne ptr %173, null, !dbg !901
  br i1 %174, label %Then40, label %Else40, !dbg !901

Then39:                                           ; preds = %Block38
  br label %Block39, !dbg !903

Else39:                                           ; preds = %Block38
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !905
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !906
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !907
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !907
  ret void, !dbg !907

Block40:                                          ; preds = %Then40
  %175 = phi ptr [ %173, %Then40 ], !dbg !908
  store ptr %175, ptr %8, align 8, !dbg !908
    #dbg_declare(ptr %8, !909, !DIExpression(), !908)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %172), !dbg !910
  %176 = call ptr @vector_value_push(ptr align 1 %2, ptr align 1 %175, ptr align 1 %160), !dbg !911
  %177 = icmp ne ptr %176, null, !dbg !911
  br i1 %177, label %Then41, label %Else41, !dbg !911

Then40:                                           ; preds = %Block39
  br label %Block40, !dbg !913

Else40:                                           ; preds = %Block39
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !915
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !916
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !917
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !917
  ret void, !dbg !917

Block41:                                          ; preds = %Then41
  %178 = phi ptr [ %176, %Then41 ], !dbg !918
  store ptr %178, ptr %7, align 8, !dbg !918
    #dbg_declare(ptr %7, !919, !DIExpression(), !918)
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %175), !dbg !920
  %179 = call ptr @value_create_list(ptr align 1 %2, ptr align 1 %178), !dbg !921
  %180 = icmp ne ptr %179, null, !dbg !921
  br i1 %180, label %Then42, label %Else42, !dbg !921

Then41:                                           ; preds = %Block40
  br label %Block41, !dbg !923

Else41:                                           ; preds = %Block40
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !925
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !926
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !927
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 @3, i64 16, i1 false), !dbg !927
  ret void, !dbg !927

Block42:                                          ; preds = %Then42
  %181 = phi ptr [ %179, %Then42 ], !dbg !928
  store ptr %181, ptr %6, align 8, !dbg !928
    #dbg_declare(ptr %6, !929, !DIExpression(), !928)
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !930
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !931
  %182 = getelementptr inbounds { ptr, i16, [6 x i8] }, ptr %5, i32 0, i32 1, !dbg !932
  store i16 0, ptr %182, align 2, !dbg !932
  %183 = getelementptr inbounds { ptr, i16, [6 x i8] }, ptr %5, i32 0, i32 0, !dbg !932
  store ptr %181, ptr %183, align 8, !dbg !932
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %0, ptr align 8 %5, i64 16, i1 false), !dbg !932
  ret void, !dbg !932
...
Else42:                                           ; preds = %Block41
  call void @value_free_atom(ptr align 1 %2, ptr readonly align 1 %64), !dbg !935
  call void @vector_value_destroy(ptr align 1 %2, ptr align 1 %58), !dbg !936
  notail call fastcc void @builtin.returnError(ptr %1) #6, !dbg !937
...
declare ptr @value_get_list(ptr align 1, ptr readonly align 1) #2

; Function Attrs: noinline nounwind sspstrong uwtable
define internal fastcc void @builtin.returnError(ptr nonnull %0) unnamed_addr #3 !dbg !938 {
Entry:
...
; Function Attrs: nounwind uwtable
declare i64 @vector_value_len(ptr readonly align 1) #2

; Function Attrs: nounwind uwtable
declare void @vector_value_destroy(ptr align 1, ptr align 1) #2

; Function Attrs: nounwind uwtable
declare ptr @vector_value_at(ptr readonly align 1, i64) #2

; Function Attrs: nounwind uwtable
declare ptr @value_get_atom(ptr align 1, ptr readonly align 1) #2

; Function Attrs: nounwind uwtable
declare ptr @value_create_identifier(ptr align 1, ptr nonnull readonly align 1) #2

; Function Attrs: nounwind uwtable
declare void @value_free_atom(ptr align 1, ptr readonly align 1) #2

; Function Attrs: nounwind uwtable
declare ptr @vector_value_create(ptr align 1) #2

; Function Attrs: nounwind uwtable
declare ptr @vector_value_push(ptr align 1, ptr align 1, ptr align 1) #2

; Function Attrs: nounwind uwtable
declare ptr @value_create_list(ptr align 1, ptr align 1) #2

; Function Attrs: nounwind uwtable
declare ptr @value_create_type_expr(ptr align 1, ptr align 1) #2

; Function Attrs: nounwind uwtable
declare ptr @value_create_keyword(ptr align 1, ptr nonnull readonly align 1) #2

; Function Attrs: nounwind uwtable
declare ptr @value_create_map(ptr align 1, ptr align 1) #2
...
Entry:
  ...
  %10 = alloca ptr, align 8
  %11 = alloca ptr, align 8
  %12 = alloca %builtin.StackTrace, align 8
  %13 = alloca [32 x i64], align 8
  %14 = getelementptr inbounds %builtin.StackTrace, ptr %12, i32 0, i32 1
  %15 = getelementptr inbounds [32 x i64], ptr %13, i64 0, i64 0
  %16 = insertvalue { ptr, i64 } poison, ptr %15, 0
  %17 = insertvalue { ptr, i64 } %16, i64 32, 1
  store { ptr, i64 } %17, ptr %14, align 8
  %18 = getelementptr inbounds %builtin.StackTrace, ptr %12, i32 0, i32 0
  store i64 0, ptr %18, align 8
  %19 = getelementptr inbounds %builtin.StackTrace, ptr %12, i32 0, i32 0
  %20 = load i64, ptr %19, align 8
  %21 = call ptr @allocator_create_c(), !dbg !967
  %22 = icmp ne ptr %21, null, !dbg !967
  br i1 %22, label %Then, label %Else, !dbg !967

Block:                                            ; preds = %Then
  %23 = phi ptr [ %21, %Then ], !dbg !969
  store ptr %23, ptr %11, align 8, !dbg !969
    #dbg_declare(ptr %11, !970, !DIExpression(), !969)
  %24 = call ptr @value_create_identifier(ptr align 1 %23, ptr nonnull readonly align 1 @__anon_1755), !dbg !971
  %25 = icmp ne ptr %24, null, !dbg !971
  br i1 %25, label %Then1, label %Else1, !dbg !971
...
Block1:                                           ; preds = %Then1
  %26 = phi ptr [ %24, %Then1 ], !dbg !976
  store ptr %26, ptr %10, align 8, !dbg !976
    #dbg_declare(ptr %10, !977, !DIExpression(), !976)
  %27 = call ptr @value_create_symbol(ptr align 1 %23, ptr nonnull readonly align 1 @__anon_1761), !dbg !978
  %28 = icmp ne ptr %27, null, !dbg !978
  br i1 %28, label %Then2, label %Else2, !dbg !978
...
Block2:                                           ; preds = %Then2
  %29 = phi ptr [ %27, %Then2 ], !dbg !983
  store ptr %29, ptr %9, align 8, !dbg !983
    #dbg_declare(ptr %9, !984, !DIExpression(), !983)
  %30 = call ptr @value_create_identifier(ptr align 1 %23, ptr nonnull readonly align 1 @__anon_1766), !dbg !985
  %31 = icmp ne ptr %30, null, !dbg !985
  br i1 %31, label %Then3, label %Else3, !dbg !985
...
Block3:                                           ; preds = %Then3
  %32 = phi ptr [ %30, %Then3 ], !dbg !990
  store ptr %32, ptr %8, align 8, !dbg !990
    #dbg_declare(ptr %8, !991, !DIExpression(), !990)
  %33 = call ptr @vector_value_create(ptr align 1 %23), !dbg !992
  %34 = icmp ne ptr %33, null, !dbg !992
  br i1 %34, label %Then4, label %Else4, !dbg !992
...
Block4:                                           ; preds = %Then4
  %35 = phi ptr [ %33, %Then4 ], !dbg !997
  store ptr %35, ptr %7, align 8, !dbg !997
    #dbg_declare(ptr %7, !998, !DIExpression(), !997)
  %36 = call ptr @vector_value_push(ptr align 1 %23, ptr align 1 %35, ptr align 1 %26), !dbg !999
  %37 = icmp ne ptr %36, null, !dbg !999
  br i1 %37, label %Then5, label %Else5, !dbg !999
...
Block5:                                           ; preds = %Then5
  %38 = phi ptr [ %36, %Then5 ], !dbg !1004
  store ptr %38, ptr %6, align 8, !dbg !1004
    #dbg_declare(ptr %6, !1005, !DIExpression(), !1004)
  call void @vector_value_destroy(ptr align 1 %23, ptr align 1 %35), !dbg !1006
  %39 = call ptr @vector_value_push(ptr align 1 %23, ptr align 1 %38, ptr align 1 %29), !dbg !1007
  %40 = icmp ne ptr %39, null, !dbg !1007
  br i1 %40, label %Then6, label %Else6, !dbg !1007
...
Block6:                                           ; preds = %Then6
  %41 = phi ptr [ %39, %Then6 ], !dbg !1012
  store ptr %41, ptr %5, align 8, !dbg !1012
    #dbg_declare(ptr %5, !1013, !DIExpression(), !1012)
  call void @vector_value_destroy(ptr align 1 %23, ptr align 1 %38), !dbg !1014
  %42 = call ptr @vector_value_push(ptr align 1 %23, ptr align 1 %41, ptr align 1 %32), !dbg !1015
  %43 = icmp ne ptr %42, null, !dbg !1015
  br i1 %43, label %Then7, label %Else7, !dbg !1015
...
Block7:                                           ; preds = %Then7
  %44 = phi ptr [ %42, %Then7 ], !dbg !1020
  store ptr %44, ptr %4, align 8, !dbg !1020
    #dbg_declare(ptr %4, !1021, !DIExpression(), !1020)
  call void @vector_value_destroy(ptr align 1 %23, ptr align 1 %41), !dbg !1022
  %45 = call ptr @value_create_list(ptr align 1 %23, ptr align 1 %44), !dbg !1023
  %46 = icmp ne ptr %45, null, !dbg !1023
  br i1 %46, label %Then8, label %Else8, !dbg !1023
...
Block8:                                           ; preds = %Then8
  %47 = phi ptr [ %45, %Then8 ], !dbg !1028
  store ptr %47, ptr %3, align 8, !dbg !1028
    #dbg_declare(ptr %3, !1029, !DIExpression(), !1028)
  call fastcc void @c_api_transform.transformCallToOperation(ptr sret({ ptr, i16, [6 x i8] }) %2, ptr %12, ptr align 1 %23, ptr align 1 %47), !dbg !1030
  %48 = getelementptr inbounds { ptr, i16, [6 x i8] }, ptr %2, i32 0, i32 1, !dbg !1030
  %49 = load i16, ptr %48, align 2, !dbg !1030
  %50 = icmp eq i16 %49, 0, !dbg !1030
  br i1 %50, label %Then9, label %Else9, !dbg !1030
...
!2 = !DIFile(filename: "builtin.zig", directory: "/Users/jimmyhmiller/.cache/zig/b/f230444ddd198d33cd8675628a671d65")
