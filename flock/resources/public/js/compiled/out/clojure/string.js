...
{{
var G__15615 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15615;
continue;
}
} else
...
{var pred__15619 = cljs.core._EQ_;var expr__15620 = limit;if(cljs.core.truth_(pred__15619.call(null,1,expr__15620)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15619.call(null,2,expr__15620)))
...
var G__15622 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15623 = (limit__$1 - 1);
var G__15624 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15622;
limit__$1 = G__15623;
parts = G__15624;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___15626 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___15626))
{var replacement_15627 = temp__4124__auto___15626;buffer.append([cljs.core.str(replacement_15627)].join(''));
} else
{buffer.append(ch);
}
{
var G__15628 = (index + 1);
index = G__15628;
continue;
}
}
