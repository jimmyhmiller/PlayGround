...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_18582 = 0;while(true){
if((i_18582 < arr.length))
{(arr[i_18582] = null);
{
...
{var i_18589 = (self__.level + 1);while(true){
if((i_18589 <= (new_level + 1)))
{(update[i_18589] = self__.header);
{
var G__18590 = (i_18589 + 1);
i_18589 = G__18590;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_18591 = 0;while(true){
if((i_18591 <= self__.level))
{var links_18592 = (update[i_18591]).forward;if(((links_18592[i_18591]) === x__$1))
{(links_18592[i_18591] = (x__$1.forward[i_18591]));
{
var G__18593 = (i_18591 + 1);
i_18591 = G__18593;
continue;
}
} else
{{
var G__18594 = (i_18591 + 1);
i_18591 = G__18594;
continue;
}
}
