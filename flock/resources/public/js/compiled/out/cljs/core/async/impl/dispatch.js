...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_18673 = 0;while(true){
var m_18674 = cljs.core.async.impl.dispatch.tasks.pop();if((m_18674 == null))
{} else
{m_18674.call(null);
if((count_18673 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__18675 = (count_18673 + 1);
count_18673 = G__18675;
continue;
}
} else
{}
