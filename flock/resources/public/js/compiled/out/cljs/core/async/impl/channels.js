...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t18679 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t18679 = (function (val,box,meta18680){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t18679.cljs$lang$type = true;
cljs.core.async.impl.channels.t18679.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t18679";
cljs.core.async.impl.channels.t18679.cljs$lang$ctorPrWriter = (function (this__8441__auto__,writer__8442__auto__,opt__8443__auto__){return cljs.core._write.call(null,writer__8442__auto__,"cljs.core.async.impl.channels/t18679");
});
cljs.core.async.impl.channels.t18679.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t18679.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18681){var self__ = this;
var _18681__$1 = this;return self__.meta18680;
});
cljs.core.async.impl.channels.t18679.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18681,meta18680__$1){var self__ = this;
var _18681__$1 = this;return (new cljs.core.async.impl.channels.t18679(self__.val,self__.box,meta18680__$1));
});
cljs.core.async.impl.channels.__GT_t18679 = (function __GT_t18679(val__$1,box__$1,meta18680){return (new cljs.core.async.impl.channels.t18679(val__$1,box__$1,meta18680));
});
}
return (new cljs.core.async.impl.channels.t18679(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_18682 = self__.takes.pop();if((taker_18682 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_18682))
{var take_cb_18683 = cljs.core.async.impl.protocols.commit.call(null,taker_18682);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_18683,taker_18682,this$__$1){
return (function (){return take_cb_18683.call(null,null);
});})(take_cb_18683,taker_18682,this$__$1))
);
} else
{}
{
