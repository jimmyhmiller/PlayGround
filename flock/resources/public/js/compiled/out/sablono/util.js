...
sablono.util.ToString = (function (){var obj15634 = {};return obj15634;
})();
...
sablono.util.ToURI = (function (){var obj15636 = {};return obj15636;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__15637){
var xs = cljs.core.seq(arglist__15637);
...
{var vec__15639 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__15639,0,null);var words = cljs.core.nthnext.call(null,vec__15639,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__15640_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__15640_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15640_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__15640_SHARP_))
{return p1__15640_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__15641){
var maps = cljs.core.seq(arglist__15641);
...
*/
sablono.util.normalize_element = (function normalize_element(p__15646){var vec__15649 = p__15646;var tag = cljs.core.nth.call(null,vec__15649,0,null);var content = cljs.core.nthnext.call(null,vec__15649,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
