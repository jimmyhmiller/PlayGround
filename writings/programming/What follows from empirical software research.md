...
So the question is could we have known P(positive) without having read the research? Well, one way of taking P(positive) is a rather particular claim. It is a statistical claim about the effect of TDD on some population of engineers. Taken that way it seems unlikely that before reading the research anyone believed that P(positive) was true. What they probably believed was something a bit more vague than that, something like TDD has the ability to increase code quality, productivity, and reduce testing effort for some people in some circumstances. Can we know a claim like this without a study? Can we know that dogs relieve stress for some people in some circumstances? It's hard to see why we couldn't.
...
What doesn’t follow from any of these circumstances is a move from “superstition” and “opinion” to knowledge. To suggest so is to misunderstand how knowledge works and to overly simplify the noetic structure of human beings. We can accept a study and yet still believe something on the basis of “superstition” and “opinion”. We can have knowledge of many things without having an empirical study. Of course, there is something beyond the rhetoric that these statements are trying to get at. We should believe things on the basis of evidence, we shouldn't make claims we aren't warranted in making. But conflating that with statements about our current beliefs being based on "supersistion" or "opinion" is just pure rhetoric.
...
So why care about empirical results at all? Well, I enjoy knowing things. I think the more we understand the better. But the question still remains, do empirical results have a large role to play in questions like the following?
...
Alone they don't. Only when our goals, desires, and background beliefs align with what the research shows does it at all follow that we have any answer to these questions. Yet even then, there are no easy answers. These questions must be answered by individuals. There will be no global ought for the industry.
