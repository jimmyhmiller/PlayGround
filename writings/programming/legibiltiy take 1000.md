...
A propreitary, fully in-house, codebase is no different. Different teams work on them. Different parts of the codebase satisfy the needs of different customers. Different parts of the codebase have different constraints, have different requirements, require different upkeep. Yes the company made this codebase "to make money" just as we cultivated forests to "make wood" but that does not stop the codebase from having its own internal structure, from having different relationships to different things. 
