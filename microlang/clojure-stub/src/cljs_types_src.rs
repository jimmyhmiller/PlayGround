...
(defn meta [x] (-meta x))
;; A Var's metadata: :name/:ns (as symbols) plus the :dynamic/:private/:macro flags
;; from the runtime var registry. (:doc/:arglists would need a defn capture pass.)
(extend-type Var
  IMeta (-meta [v]
