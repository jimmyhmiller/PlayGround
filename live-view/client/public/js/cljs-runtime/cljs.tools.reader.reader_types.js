...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_36733 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_36733(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_36734 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_36734(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_36735 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_36735(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_36739 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_36739(reader);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_36750 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_36750(reader);
}
});
...
var G__36851 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__36852 = s.append(c);
c = G__36851;
s = G__36852;
continue;
}
