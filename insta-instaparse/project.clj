(defproject insta-instaparse "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "insta-instaparse.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main insta-instaparse.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "insta-instaparse.core/on-figwheel-reload"}

                :compiler {:main insta-instaparse.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/insta_instaparse.js"
                          ...
                          {:test
                           {:source-paths ["src/cljs" "test/cljs"]
                            ...
                            {:output-to "resources/public/js/compiled/testable.js"
                             :main insta-instaparse.test-runner
                             :optimizations :none}}}}}
