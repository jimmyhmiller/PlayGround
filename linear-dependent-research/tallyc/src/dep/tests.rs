...
fn tree_sig() -> Signature {
    Signature { linear_types: Default::default(),
        postulates: vec![],
        datas: vec![
...
fn strict_positivity_rejects_negative_and_double_negative_occurrences() {
    ...
    let neg = Signature { linear_types: Default::default(),
        postulates: vec![],
        datas: vec![datadecl(
            "Bad",
            vec![],
    ...
    let dneg = Signature { linear_types: Default::default(),
        postulates: vec![],
        datas: vec![datadecl(
            "Bad",
            vec![],
...
fn positivity_sees_through_natcase_and_fix_hiding_a_negative_occurrence() {
    ...
    let sig = Signature { linear_types: Default::default(),
        postulates: vec![],
    ...
    let sig2 = Signature { linear_types: Default::default(),
        postulates: vec![],
...
fn m2_higher_order_eliminator_uses_both_telescope_arguments() {
    ...
    let sig = Signature { linear_types: Default::default(), postulates: vec![], datas: vec![bool_d, tri_d] };
...
fn indexed_higher_order_ih_uses_the_recursive_occurrences_own_index() {
    ...
    let sig = Signature { linear_types: Default::default(), postulates: vec![], datas: vec![bool_d, g_d] };
    assert!(check_signature(&sig).is_ok(), "{:?}", check_signature(&sig));
...
fn acc_accessibility_family_is_well_formed() {
    ...
    let bad = Signature { linear_types: Default::default(),
        postulates: vec![],
        datas: vec![datadecl(
            "Acc",
...
fn a_parameter_ranging_over_a_universe_lifts_the_datatype_universe() {
    ...
    let mk_box = |universe: usize| Signature { linear_types: Default::default(),
        postulates: vec![],
        datas: vec![DataDecl {
            name: "Box".into(),
            universe,
...
fn an_index_ranging_over_a_universe_lifts_the_datatype_universe() {
    ...
    let mk_tag = |universe: usize| Signature { linear_types: Default::default(),
        postulates: vec![],
        datas: vec![DataDecl {
            name: "Tag".into(),
            universe,
...
fn vec_style_value_parameter_does_not_over_restrict() {
    ...
    let box0 = Signature { linear_types: Default::default(),
        postulates: vec![],
        datas: vec![DataDecl {
            name: "Phantom".into(),
            universe: 0,
...
fn struct_predicativity_diagnostic_does_not_double_name() {
    ...
    let sbox = Signature { linear_types: Default::default(),
        postulates: vec![],
        datas: vec![DataDecl {
            name: "SBox".into(),
            universe: 0,
