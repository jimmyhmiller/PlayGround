...
public class ParserBenchmark {
    ...
    // Medium code sample - typical callback-based data fetcher (ES5)
    ...
    // Large code sample - complex module with multiple functions (ES5)
    ...
    @Benchmark
    public Program parseSmallFunction() {
        Parser parser = new Parser(SMALL_FUNCTION, false);
        return parser.parse();
    }

    @Benchmark
    public Program parseSmallClass() {
    ...
    @Benchmark
    public Program parseMediumAsyncModule() {
    ...
    @Benchmark
    public Program parseLargeModule() {
