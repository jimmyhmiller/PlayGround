"""Benchmark different model configs: eager vs compile, d128 vs d256."""
...
if __name__ == "__main__":
    ...
    configs = [
        ("d128 eager fp16",   128, 4, 4, False),
        ("d128 compile fp16", 128, 4, 4, True),
        ("d256 eager fp16",   256, 8, 4, False),
        ("d256 compile fp16", 256, 8, 4, True),
    ]
