            ...
            group.bench_with_input(
                ...
                |b, pass| {
                    b.iter(|| {
                        ...
                        let mut graph = Graph::new(layout_provider, black_box(pass.clone()), options.clone());
...
criterion_group!(benches, bench_complete_layout, bench_svg_rendering, bench_end_to_end);
