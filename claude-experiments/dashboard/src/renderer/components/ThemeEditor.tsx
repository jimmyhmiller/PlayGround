import { memo, useState, useEffect, ChangeEvent, ReactElement } from 'react';
 ...
 */
const ThemeEditor = memo(function ThemeEditor(): ReactElement {
  const {
    currentTheme,
    presetThemes,
    setTheme,
...
const ThemeVariable = memo(function ThemeVariable({
  ...
  onChange,
  onReset,
}: ThemeVariableProps): ReactElement {
