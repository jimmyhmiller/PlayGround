import { memo, useRef, ReactNode, ReactElement } from 'react';
...
const Level = memo(function Level({ depth, children }: LevelProps): ReactElement {
...
function DeepNesting(): ReactElement {
  const renderCount = useRef(0);
  renderCount.current += 1;
