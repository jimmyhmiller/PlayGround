...
const CodeMirrorEditor = memo(function CodeMirrorEditor({
  ...
  filePath = null,
  content = null, // Persisted content from window props
  onUpdateProps, // Callback to persist state to window props
  ...
  const fileEvent = useLatestEvent(subscribePattern);
  ...
  const saveContent = useRef((newContent) => {
