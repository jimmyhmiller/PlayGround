...
// Floating-point / SIMD registers (D0-D31 = 64-bit double)
// These use X64 size to indicate 64-bit, but the index encodes the FP reg number.
// The caller must use them only with FP instructions.
pub const D0: Arm64Reg = Arm64Reg::new(0, RegSize::X64);
pub const D1: Arm64Reg = Arm64Reg::new(1, RegSize::X64);
pub const D2: Arm64Reg = Arm64Reg::new(2, RegSize::X64);
pub const D3: Arm64Reg = Arm64Reg::new(3, RegSize::X64);
pub const D4: Arm64Reg = Arm64Reg::new(4, RegSize::X64);
pub const D5: Arm64Reg = Arm64Reg::new(5, RegSize::X64);
pub const D6: Arm64Reg = Arm64Reg::new(6, RegSize::X64);
pub const D7: Arm64Reg = Arm64Reg::new(7, RegSize::X64);
pub const D8: Arm64Reg = Arm64Reg::new(8, RegSize::X64);
pub const D9: Arm64Reg = Arm64Reg::new(9, RegSize::X64);
pub const D10: Arm64Reg = Arm64Reg::new(10, RegSize::X64);
pub const D11: Arm64Reg = Arm64Reg::new(11, RegSize::X64);
pub const D12: Arm64Reg = Arm64Reg::new(12, RegSize::X64);
pub const D13: Arm64Reg = Arm64Reg::new(13, RegSize::X64);
pub const D14: Arm64Reg = Arm64Reg::new(14, RegSize::X64);
pub const D15: Arm64Reg = Arm64Reg::new(15, RegSize::X64);
pub const D16: Arm64Reg = Arm64Reg::new(16, RegSize::X64);
pub const D17: Arm64Reg = Arm64Reg::new(17, RegSize::X64);
pub const D18: Arm64Reg = Arm64Reg::new(18, RegSize::X64);
pub const D19: Arm64Reg = Arm64Reg::new(19, RegSize::X64);
pub const D20: Arm64Reg = Arm64Reg::new(20, RegSize::X64);
pub const D21: Arm64Reg = Arm64Reg::new(21, RegSize::X64);
pub const D22: Arm64Reg = Arm64Reg::new(22, RegSize::X64);
pub const D23: Arm64Reg = Arm64Reg::new(23, RegSize::X64);
pub const D24: Arm64Reg = Arm64Reg::new(24, RegSize::X64);
pub const D25: Arm64Reg = Arm64Reg::new(25, RegSize::X64);
pub const D26: Arm64Reg = Arm64Reg::new(26, RegSize::X64);
pub const D27: Arm64Reg = Arm64Reg::new(27, RegSize::X64);
pub const D28: Arm64Reg = Arm64Reg::new(28, RegSize::X64);
pub const D29: Arm64Reg = Arm64Reg::new(29, RegSize::X64);
pub const D30: Arm64Reg = Arm64Reg::new(30, RegSize::X64);
pub const D31: Arm64Reg = Arm64Reg::new(31, RegSize::X64);
