//! Standard `PtrPolicy` implementations for common value-layout schemes.
//!
//! A `PtrPolicy` tells the GC how to recognize and decode a heap-pointer
//! NanBox from a generic u64 slot value. Each value-encoding scheme has
//! a canonical policy here; frontends pick the one matching their layout.
