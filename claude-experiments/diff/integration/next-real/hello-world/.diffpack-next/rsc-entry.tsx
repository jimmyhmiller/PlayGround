...
import M0 from "/Users/jimmyhmiller/Documents/Code/PlayGround/claude-experiments/diff/integration/next-real/hello-world/.diffpack-next/error-boundary.tsx";
import M1 from "/Users/jimmyhmiller/Documents/Code/PlayGround/claude-experiments/diff/integration/next-real/hello-world/app/page.tsx";
import M2 from "/Users/jimmyhmiller/Documents/Code/PlayGround/claude-experiments/diff/integration/next-real/hello-world/app/layout.tsx";

const MIDDLEWARE = null;
const ROUTES = [
  { path: "/", segments: [], page: M1, levels: [{ layout: M2, loading: null, error: null, slotBase: 0, slots: [] }, ], metaChain: [null], pageMeta: null, title: null, description: null, kind: "static", hasGenerateStaticParams: false, dynamicParams: true },
];
...
const ROOT_META = { title: null, description: null };
