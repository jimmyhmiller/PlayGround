...
#include "maldoca/astgen/test/region/rir_dialect.cc.inc"

/// Dialect initialization, the instance will be owned by the context. This is
/// the point of registration of types and operations for the dialect.
void maldoca::RirDialect::initialize() {
  addTypes<
#define GET_TYPEDEF_LIST
#include "maldoca/astgen/test/region/rir_types.cc.inc"
      >();

  addOperations<
#define GET_OP_LIST
#include "maldoca/astgen/test/region/rir_ops.cc.inc"
      >();
}
...
#include "maldoca/astgen/test/region/interfaces.cc.inc"
...
bool IsExprRegion(mlir::Region &region) {
  ...
  return llvm::isa<RirExprRegionEndOp>(terminator);
}
...
bool IsExprsRegion(mlir::Region &region) {
  ...
  auto *terminator = &block.back();
  return llvm::isa<RirExprsRegionEndOp>(terminator);
}
