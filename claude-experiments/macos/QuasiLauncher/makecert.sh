...
openssl x509 -req -in cert_request.csr -signkey private_key.pem -out certificate.pem -days 365 -extensions codesign_ext -extfile <(echo "
[codesign_ext]
keyUsage=digitalSignature
extendedKeyUsage=codeSigning
")

# Step 4: Create a PKCS#12 bundle
...
rm private_key.pem cert_request.csr certificate.pem certificate.p12
