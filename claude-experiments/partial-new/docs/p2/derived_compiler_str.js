function main(v0) {
  let v1002, v1003, v1004, v1005, v1006, v1007, v1008, v1009, v1010, v1011, v100004, v500078, v500082, v500107, v700003, v700004, v700005, v700006, v700007, v700008, v700009, v700010, v700011;
  let __pc = 0;
  for (;;) {
    switch (__pc) {
      case 0: {
      ...
      case 22: {
        v500078 = v1002.pop();
        v500082 = v1002.pop();
        v1002.push((((((("(" + v500082) + " ") + v1007) + " ") + v500078) + ")"));
        v700010 = v500078;
        v700011 = v500082;
        v1010 = v700010;
        v1011 = v700011;
