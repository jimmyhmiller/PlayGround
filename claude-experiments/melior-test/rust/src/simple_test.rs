...
fn create_simple_llvm_function(
    context: &Context,
    module: &Module,
    ...
    let function = OperationBuilder::new("llvm.func", location)
        .add_attributes(&[
            (
                ...
                StringAttribute::new(context, "simple").into(),
            ),
            (
            ...
            (
                ...
                StringAttribute::new(context, "external").into(),
            ),
        ])
    ...
    // Add llvm.return
    let return_op = OperationBuilder::new("llvm.return", location).build()?;
