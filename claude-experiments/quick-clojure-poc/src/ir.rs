...
pub enum Instruction {
    ...
    /// MakeTypeWithSaves(dst, type_id, field_values, saves) - MakeType with register preservation
    /// Generated by register allocator from MakeType
    MakeTypeWithSaves(IrValue, usize, Vec<IrValue>, Vec<IrValue>),
