;; ============================================================
;; Comprehensive Bug-Finding Test Suite
;; Documents bugs found and tests all working functionality
;; ============================================================

;; ============= BUGS FOUND =============
;; BUG 1: (count (list ...)) - ICounted protocol not implemented for list type
;; BUG 2: (assoc ...) and (dissoc ...) print #<clojure.core/PersistentHashMap@...>
;;        instead of the actual map contents
;; BUG 3: (conj #{1 2} 3) returns [1 2 3] (vector) instead of #{1 2 3} (set)
;;        Set conj is broken - returns vector instead of set
;;
;; NOT IMPLEMENTED (missing functions):
;; - map, filter, apply, disj, even?, odd?
;;
;; ============= TESTS =============
...
;; Note: assoc/dissoc work but print addresses
...
;; BUG: (println (conj #{1 2} 3)) ;; Returns vector [1 2 3] not set
...
(println (if {} "t" "f"))     ;; t
(println (if "" "t" "f"))     ;; t (empty string is truthy)
