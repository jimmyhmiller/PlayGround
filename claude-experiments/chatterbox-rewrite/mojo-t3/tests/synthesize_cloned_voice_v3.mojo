...
def main() raises:
    ...
    var mel = load_fp32("tests/fixtures/real/e2e_mojo_mel.bin")
    var s_stft = load_fp32("tests/fixtures/real/e2e_mojo_s_stft.bin")
    ...
    with audio_buf.map_to_host() as h:
        for i in range(n_audio):
            ...
            if v < -0.99: v = -0.99
            samples.append(v)
    save_wav("e2e_mojo_audio.wav", samples, 24000)
