...
use std::sync::Arc;
use cf_tokio::net::{TcpListener, TcpStream};
use cf_tokio::sync::{broadcast, mpsc, Semaphore};
use cf_tokio::time::{self, Duration};
...
/// gracefully.
///
/// `cf_tokio::signal::ctrl_c()` can be used as the `shutdown` argument. This will
...
impl Handler {
    ...
    async fn run(&mut self) -> crate::Result<()> {
        ...
        while !self.shutdown.is_shutdown() {
            ...
            // signal.
            let maybe_frame = cf_tokio::select! {
