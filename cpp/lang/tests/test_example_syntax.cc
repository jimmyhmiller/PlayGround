...
void test_empty_list_literal() {
  ...
  if (expr->type == ASTNodeType::ListLiteral) {
    ...
    std::cout << "❌ FAILED: Empty list parsed as: "
              << static_cast<int>(expr->type) << std::endl;
  }
  std::cout << std::endl;
}
...
void test_list_literal_with_elements() {
  ...
  if (expr->type == ASTNodeType::ListLiteral) {
    ...
    std::cout << "❌ FAILED: List literal parsed as: "
              << static_cast<int>(expr->type) << std::endl;
  }
  std::cout << std::endl;
}
...
void test_tuple_literal() {
  ...
  if (expr->type == ASTNodeType::TupleLiteral) {
    ...
    std::cout << "❌ FAILED: Tuple literal parsed as: "
              << static_cast<int>(expr->type) << std::endl;
  }
  std::cout << std::endl;
}
...
void test_lambda_expression() {
  ...
  if (first->type == ASTNodeType::ExpressionStatement) {
    ...
    if (expr->type == ASTNodeType::LambdaExpression) {
      std::cout << "✅ SUCCESS: Lambda expression parsed correctly"
                << std::endl;
    } else {
      std::cout << "❌ FAILED: Lambda expression parsed as: "
                << static_cast<int>(expr->type) << std::endl;
    }
  } else {
    std::cout << "❌ FAILED: Expected ExpressionStatement, got: "
              << static_cast<int>(first->type) << std::endl;
  }
  std::cout << std::endl;
}
...
void test_function_call() {
  ...
  if (expr->type == ASTNodeType::FunctionCall) {
    ...
    std::cout << "❌ FAILED: Function call parsed as: "
              << static_cast<int>(expr->type) << std::endl;
  }
  std::cout << std::endl;
}
...
void test_logical_or() {
  ...
  if (expr->type == ASTNodeType::BinaryExpression) {
    std::cout << "✅ SUCCESS: Logical OR parsed as binary expression"
              << std::endl;
  } else {
    std::cout << "❌ FAILED: Logical OR parsed as: "
              << static_cast<int>(expr->type) << std::endl;
  }
  std::cout << std::endl;
}
...
void test_generic_types() {
  ...
  if (first->type == ASTNodeType::FunctionDeclaration) {
    ...
    std::cout << "❌ FAILED: Generic function parsed as: "
              << static_cast<int>(first->type) << std::endl;
  }
  std::cout << std::endl;
}
...
void test_complex_types() {
  ...
  if (first->type == ASTNodeType::FunctionDeclaration) {
    std::cout << "✅ SUCCESS: Complex type function parsed correctly"
              << std::endl;
  } else {
    std::cout << "❌ FAILED: Complex type function parsed as: "
              << static_cast<int>(first->type) << std::endl;
  }
  std::cout << std::endl;
}
...
int main() {
  std::cout << "Testing example.txt syntax support..." << std::endl
            << std::endl;
